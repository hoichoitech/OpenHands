...
//#region src/components/features/settings/integrations-settings-link.tsx
function m() {
	let { t: m } = e("openhands"), { active: h } = s(), { backend: g, orgId: _ } = h;
	if (o(g) || g.kind !== "cloud" || a() !== null) return null;
	let v = _ ? `?org=${encodeURIComponent(_)}` : "";
	return /* @__PURE__ */ p("a", {
		"data-testid": "settings-integrations-link",
		href: `${g.host.replace(/\/+$/, "")}/settings/integrations${v}`,
		target: "_blank",
		...
		children: [
			...
			/* @__PURE__ */ f("span", {
				...
				children: m(t.SETTINGS$INTEGRATIONS_SETTINGS_LINK)
			}),
			/* @__PURE__ */ f(n, {
...
//#endregion
export { m as IntegrationsSettingsLink };

//# sourceMappingURL=integrations-settings-link.js.map