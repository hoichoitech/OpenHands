import type { AgentProfile, AgentProfileSaveInput } from "#/api/agent-profiles-service/agent-profiles-service.api";
/**
 ...
 */
export declare function mergeAgentProfileSaveInput(stored: AgentProfile | null, edited: AgentProfileSaveInput): AgentProfileSaveInput;
