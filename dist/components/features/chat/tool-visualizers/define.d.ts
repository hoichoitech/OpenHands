...
import { Action, Observation, ActionEvent, ObservationEvent } from "#/types/agent-server/core";
type ActionKind = Action["kind"];
type ObservationKind = Observation["kind"];
type ActionByKind<K extends ActionKind> = Extract<Action, {
    kind: K;
}>;
type ObservationByKind<K extends ObservationKind> = Extract<Observation, {
    kind: K;
}>;
/**
 ...
 */
export declare const defineVisualizer: <AK extends ActionKind, OK extends ObservationKind = never>(visualizer: ToolVisualizer<AK, OK>) => RegisteredVisualizer;
export {};
