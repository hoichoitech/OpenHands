...
//#region src/components/features/conversation-panel/skills-modal-header.tsx
...
function f({ isLoading: f, isRefetching: p, onRefresh: m, onClose: h }) {
	...
	return /* @__PURE__ */ u(c, { children: [/* @__PURE__ */ l(s, {
		onClose: h,
		testId: "close-skills-modal"
	}), /* @__PURE__ */ u("div", {
		className: "flex w-full items-start justify-between gap-4 pr-10",
		children: [/* @__PURE__ */ u("div", {
			className: "flex min-w-0 flex-1 flex-col gap-2",
			children: [/* @__PURE__ */ l(o, { title: g(t.SKILLS_MODAL$TITLE) }), /* @__PURE__ */ l(a.Text, {
				className: "text-sm text-[var(--oh-muted)]",
				children: g(t.SKILLS_MODAL$WARNING)
			})]
		}), /* @__PURE__ */ l(i, {
			content: _,
			placement: "bottom",
...
//#endregion
export { f as SkillsModalHeader };

//# sourceMappingURL=skills-modal-header.js.map