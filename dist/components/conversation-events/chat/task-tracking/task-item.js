...
//#region src/components/conversation-events/chat/task-tracking/task-item.tsx
function u({ task: u }) {
	...
	return /* @__PURE__ */ l("div", {
		...
		children: [/* @__PURE__ */ c("div", {
			...
			className: "flex flex-col items-start justify-center leading-[20px] text-nowrap whitespace-pre font-normal",
			children: [/* @__PURE__ */ c(r.Text, {
				className: n("text-[12px] text-white", p && "text-[var(--oh-muted)]"),
				children: u.title
