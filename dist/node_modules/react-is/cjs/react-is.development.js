...
var t = /* @__PURE__ */ e(((e) => {
	process.env.NODE_ENV !== "production" && (function() {
		...
		e.ContextConsumer = C, e.ContextProvider = w, e.Element = T, e.ForwardRef = E, e.Fragment = D, e.Lazy = O, e.Memo = k, e.Portal = A, e.Profiler = j, e.StrictMode = M, e.Suspense = N, e.SuspenseList = P, e.isAsyncMode = L, e.isConcurrentMode = R, e.isContextConsumer = z, e.isContextProvider = B, e.isElement = V, e.isForwardRef = H, e.isFragment = U, e.isLazy = W, e.isMemo = G, e.isPortal = K, e.isProfiler = q, e.isStrictMode = J, e.isSuspense = Y, e.isSuspenseList = X, e.isValidElementType = x, e.typeOf = S;
	})();
}));
//#endregion
export default t();
