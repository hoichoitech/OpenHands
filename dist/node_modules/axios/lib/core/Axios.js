...
import n from "../helpers/buildURL.js";
import r from "./InterceptorManager.js";
...
var l = c.validators, u = class {
	...
	getUri(e) {
		return e = o(this.defaults, e), n(a(e.baseURL, e.url, e.allowAbsoluteUrls, e), e.params, e.paramsSerializer);
	}
};
e.forEach([
	"delete",
	...
	u.prototype[t] = function(n, r) {
		return this.request(o(r || {}, {
			method: t,
			url: n,
			data: r && e.hasOwnProp(r, "data") ? r.data : void 0
		}));
	};
}), e.forEach([
	"post",
