...
function l(e, t) {
	return a(t) || m("changeType"), Object.keys(t).some(function(t) {
		return !c(e, t);
	}) && m("changeField"), t;
}
function u(e) {
...
function d(e) {
	s(e) || a(e) || m("handlerType"), a(e) && Object.values(e).some(function(e) {
		return !s(e);
	}) && m("handlersType");
}
function f(e) {
	e || m("initialIsRequired"), a(e) || m("initialType"), o(e) && m("initialContent");
}
function p(e, t) {
...
function g(e) {
	...
	var n = { current: e }, a = i(y)(n, t), o = i(v)(n), s = i(h.changes)(e), c = i(_)(n);
	function l() {
...
function v(e, t) {
	return e.current = n(n({}, e.current), t), t;
}
function y(e, t, n) {
