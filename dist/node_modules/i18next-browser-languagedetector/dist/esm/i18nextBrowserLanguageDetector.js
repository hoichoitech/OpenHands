...
var { slice: e, forEach: t } = [];
function n(n) {
	return t.call(e.call(arguments, 1), (e) => {
		if (e) for (let t in e) n[t] === void 0 && (n[t] = e[t]);
	}), n;
}
function r(e) {
...
var i = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/, a = function(e, t) {
	...
	create(e, t, n, r) {
		...
		n && (i.expires = /* @__PURE__ */ new Date(), i.expires.setTime(i.expires.getTime() + n * 60 * 1e3)), r && (i.domain = r), document.cookie = a(e, t, i);
	},
	read(e) {
	...
	lookup(e) {
		...
		if (t && typeof document < "u") return o.read(t) || void 0;
	},
	cacheUserLanguage(e, t) {
		let { lookupCookie: n, cookieMinutes: r, cookieDomain: i, cookieOptions: a } = t;
		n && typeof document < "u" && o.create(n, e, r, i, a);
	}
}, c = {
	name: "querystring",
	lookup(e) {
	...
	if (u !== null) return u;
	try {
		if (u = typeof window < "u" && window.localStorage !== null, !u) return !1;
	...
	lookup(e) {
		...
		if (t && d()) return window.localStorage.getItem(t) || void 0;
	},
	cacheUserLanguage(e, t) {
	...
	if (p !== null) return p;
	try {
		if (p = typeof window < "u" && window.sessionStorage !== null, !p) return !1;
		let e = "i18next.translate.boo";
	...
	lookup(e) {
		...
		if (t && m()) return window.sessionStorage.getItem(t) || void 0;
	},
	cacheUserLanguage(e, t) {
		let { lookupSessionStorage: n } = t;
		n && m() && window.sessionStorage.setItem(n, e);
	}
}, g = {
	name: "navigator",
	lookup(e) {
...
var S = () => ({
	...
	init() {
		let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : { languageUtils: {} }, t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
		this.services = e, this.options = n(t, this.options || {}, S()), typeof this.options.convertDetectedLanguage == "string" && this.options.convertDetectedLanguage.indexOf("15897") > -1 && (this.options.convertDetectedLanguage = (e) => e.replace("-", "_")), this.options.lookupFromUrlIndex && (this.options.lookupFromPathIndex = this.options.lookupFromUrlIndex), this.i18nOptions = r, this.addDetector(s), this.addDetector(c), this.addDetector(f), this.addDetector(h), this.addDetector(g), this.addDetector(_), this.addDetector(v), this.addDetector(y), this.addDetector(l);
	}
	addDetector(e) {
	...
	detect() {
		...
		}), t = t.filter((e) => e != null && !r(e)).map((e) => this.options.convertDetectedLanguage(e)), this.services && this.services.languageUtils && this.services.languageUtils.getBestMatchFromCodes ? t : t.length > 0 ? t[0] : null;
	}
	cacheUserLanguage(e) {
