...
var e = (e) => typeof e == "string", t = () => {
	...
	for (let i in n) i !== "__proto__" && i !== "constructor" && (Object.prototype.hasOwnProperty.call(t, i) ? e(t[i]) || t[i] instanceof String || e(n[i]) || n[i] instanceof String ? r && (t[i] = n[i]) : f(t[i], n[i], r) : t[i] = n[i]);
	return t;
}, p = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), m = {
	"&": "&amp;",
	"<": "&lt;",
...
function k(e, t) {
	let { [D]: n } = e(O()), r = t?.keySeparator ?? ".", i = t?.nsSeparator ?? ":", a = t?.enableSelector === "strict";
	if (n.length > 1 && i) {
...
var A = (t) => !e(t) && typeof t != "boolean" && typeof t != "number", j = class t extends w {
	...
	translate(n, r, i) {
		...
		if (b && D && O && !v.includes(j) && !(e(y) && Array.isArray(D))) {
			...
			if (t || e || o) {
				if (this.logger.log(o ? "updateKey" : "missingKey", f, u, x && !o ? `${c}${this.pluralResolver.getSuffix(f, a.count, a)}` : c, o ? E : h), s) {
	...
	init(e = {}) {
		...
		this.escape = t === void 0 ? h : t, this.escapeValue = n === void 0 ? !0 : n, this.useRawValueToEscape = r === void 0 ? !1 : r, this.prefix = i ? p(i) : a || "{{", this.suffix = o ? p(o) : s || "}}", this.formatSeparator = c || ",", this.unescapePrefix = l ? "" : u ? p(u) : "-", this.unescapeSuffix = this.unescapePrefix ? "" : l ? p(l) : "", this.nestingPrefix = d ? p(d) : f || p("$t("), this.nestingSuffix = m ? p(m) : g || p(")"), this.nestingOptionsSeparator = _ || ",", this.maxReplaces = v || 1e3, this.alwaysFormat = y === void 0 ? !1 : y, this.resetRegExp();
	}
	reset() {
	...
	interpolate(t, r, i, a) {
		...
		return [{
			...
			for (c = 0; o = r.regex.exec(t);) {
				...
				let l = r.safeValue(s);
				if (t = t.replace(o[0], L(l)), f ? (r.regex.lastIndex += l.length, r.regex.lastIndex -= o[0].length) : r.regex.lastIndex = 0, c++, c >= this.maxReplaces) break;
			}
		}), t;
	}
	nest(t, r, i = {}) {
		...
		for (; a = this.nestingRegexp.exec(t);) {
			...
			let u = /{.*}/s.test(a[1]) ? a[1].lastIndexOf("}") + 1 : a[1].indexOf(this.formatSeparator);
	...
	getFixedT(t, n, r, i) {
		let a = i?.scopeNs, o = (e, t, ...n) => {
			let i;
			i = typeof t == "object" ? { ...t } : this.options.overloadTranslationOptionHandler([e, t].concat(n)), i.lng = i.lng || o.lng, i.lngs = i.lngs || o.lngs;
			let s = i.ns !== void 0 && i.ns !== null;
			i.ns = i.ns || o.ns, i.keyPrefix !== "" && (i.keyPrefix = i.keyPrefix || r || o.keyPrefix);
			let c = {
				...this.options,
				...i
			};
			Array.isArray(a) && !s && (c.ns = a), typeof i.keyPrefix == "function" && (i.keyPrefix = k(i.keyPrefix, c));
			let l = this.options.keySeparator || ".", u;
			return i.keyPrefix && Array.isArray(e) ? u = e.map((e) => (typeof e == "function" && (e = k(e, c)), `${i.keyPrefix}${l}${e}`)) : (typeof e == "function" && (e = k(e, c)), u = i.keyPrefix ? `${i.keyPrefix}${l}${e}` : e), this.t(u, i);
		};
		return e(t) ? o.lng = t : o.lngs = t, o.ns = n, o.keyPrefix = r, o;
	}
	t(...e) {
...
}.createInstance(), X = Y.createInstance;
Y.dir, Y.init, Y.loadResources, Y.reloadResources, Y.use, Y.changeLanguage, Y.getFixedT, Y.t, Y.exists, Y.setDefaultNamespace, Y.hasLoadedNamespace, Y.loadNamespaces, Y.loadLanguages;
//#endregion
export { X as createInstance, k as keysFromSelector };
