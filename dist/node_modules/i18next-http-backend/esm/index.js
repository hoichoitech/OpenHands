...
function n(e) {
	return !(typeof e != "string" || e.length === 0 || e.length > 128 || t.indexOf(e) > -1 || e.indexOf("..") > -1 || e.indexOf("\\") > -1 || /[?#%\s]/.test(e) || /[\x00-\x1F\x7F]/.test(e));
}
function r(e) {
	return !(!n(e) || e.indexOf("/") > -1 || e.indexOf("@") > -1);
}
function i(e) {
	return n(e);
}
...
function u(e) {
	return l(e) ? e : Promise.resolve(e);
}
var d = /\{\{(.+?)\}\}/g;
function f(e, n) {
	let i = !1, o = e.replace(d, (e, o) => {
		let s = o.trim();
		if (t.indexOf(s) > -1) return e;
		let c = n[s];
		if (c == null) return e;
		let l = a[s] || r, u = String(c).split("+");
		for (let t of u) if (!l(t)) return i = !0, e;
		return u.join("+");
	});
	return i ? null : o;
}
var p = typeof globalThis < "u" ? globalThis : typeof global < "u" ? global : typeof window < "u" ? window : void 0, m;
typeof fetch == "function" ? m = fetch : p && typeof p.fetch == "function" && (m = p.fetch);
var h = c() && p ? p.XMLHttpRequest : void 0, g = typeof ActiveXObject == "function" && p ? p.ActiveXObject : void 0, _ = [
	"__proto__",
	"constructor",
	"prototype"
], v = (e, t) => {
	if (t && typeof t == "object") {
		let n = "";
		for (let e of Object.keys(t)) _.indexOf(e) > -1 || (n += "&" + encodeURIComponent(e) + "=" + encodeURIComponent(t[e]));
		if (!n) return e;
	...
	typeof fetch == "function" ? fetch(e, t).then(i).catch(n) : m(e, t).then(i).catch(n);
}, b = (e, t, n, r) => {
	...
	try {
		...
		try {
			Object.keys(a).forEach((e) => {
				delete o[e];
			}), y(t, o, r, s), e._omitFetchOptions = !0;
		} catch (e) {
			r(e);
		}
	}
}, x = (e, t, n, r) => {
	n && typeof n == "object" && (n = v("", n).slice(1)), e.queryStringParams && (t = v(t, e.queryStringParams));
	try {
		let i = h ? new h() : new g("MSXML2.XMLHTTP.3.0");
		...
		if (a = typeof a == "function" ? a() : a, a) for (let e of Object.keys(a)) _.indexOf(e) > -1 || i.setRequestHeader(e, a[e]);
	...
	if (typeof n == "function" && (r = n, n = void 0), r ||= (() => {}), m && t.indexOf("file:") !== 0) return b(e, t, n, r);
	if (c() || typeof ActiveXObject == "function") return x(e, t, n, r);
	...
	_readAny(e, t, n, r, i) {
		...
		typeof this.options.loadPath == "function" && (a = this.options.loadPath(e, n)), a = u(a), a.then((a) => {
			if (!a) return i(null, {});
			let s = f(a, {
				lng: e.join("+"),
				ns: n.join("+")
			...
			if (s == null) {
				let t = e.map(o).join(", "), r = n.map(o).join(", ");
			...
			this.loadUrl(s, i, t, r);
		});
	}
	loadUrl(e, t, n, r) {
		let i = typeof n == "string" ? [n] : n, a = typeof r == "string" ? [r] : r, c = this.options.parseLoadPayload(i, a), l = o(s(e));
		this.options.request(this.options, e, c, (e, i) => {
			if (i && (i.status >= 500 && i.status < 600 || !i.status)) return t("failed loading " + l + "; status code: " + i.status, !0);
			if (i && i.status >= 400 && i.status < 500) return t("failed loading " + l + "; status code: " + i.status, !1);
			if (!i && e && e.message) {
				...
				if ([
					...
					"network",
					"load"
				].find((e) => n.indexOf(e) > -1)) return t("failed loading " + l + ": " + o(e.message), !0);
			}
			if (e) return t(e, !1);
			let a, s;
			try {
