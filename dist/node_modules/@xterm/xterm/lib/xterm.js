...
var e = Object.defineProperty, t = Object.getOwnPropertyDescriptor, n = (t, n) => {
	for (var r in n) e(t, r, {
		get: n[r],
		enumerable: !0
	});
}, r = (n, r, i, a) => {
	for (var o = a > 1 ? void 0 : a ? t(r, i) : r, s = n.length - 1, c; s >= 0; s--) (c = n[s]) && (o = (a ? c(r, i, o) : c(o)) || o);
	return a && o && e(r, i, o), o;
}, i = (e, t) => (n, r) => t(n, r, e), a = "Terminal input", o = {
	get: () => a,
	set: (e) => a = e
}, s = "Too much output to announce, navigate to rows manually to read", c = {
	get: () => s,
	set: (e) => s = e
};
function l(e) {
...
function p(e, t, n, r) {
	e = l(e), e = u(e, n.decPrivateModes.bracketedPasteMode && r.rawOptions.ignoreBracketedPasteMode !== !0), n.triggerDataEvent(e, !0), t.value = "";
}
function m(e, t, n) {
...
var ee = class {
	...
	constructor() {
		super(...arguments), this.content = 0, this.fg = 0, this.bg = 0, this.extended = new ae(), this.combinedData = "";
	}
	...
	getChars() {
		return this.content & 2097152 ? this.combinedData : this.content & 2097151 ? g(this.content & 2097151) : "";
	}
	getCode() {
...
}, oe = "di$target", se = "di$dependencies", ce = /* @__PURE__ */ new Map();
function le(e) {
	return e[se] || [];
}
function y(e) {
...
var b = y("BufferService"), de = y("CoreMouseService"), fe = y("CoreService"), pe = y("CharsetService"), x = y("InstantiationService"), me = y("LogService"), S = y("OptionsService"), he = y("OscLinkService"), ge = y("UnicodeService"), _e = y("DecorationService"), C = class {
	constructor(e, t, n) {
	...
	provideLinks(e, t) {
		...
		let r = [], i = this._optionsService.rawOptions.linkHandler, a = new v(), o = n.getTrimmedLength(), s = -1, c = -1, l = !1;
...
var w = y("CharSizeService"), T = y("CoreBrowserService"), ye = y("MouseService"), E = y("RenderService"), be = y("SelectionService"), xe = y("CharacterJoinerService"), D = y("ThemeService"), Se = y("LinkProviderService"), Ce = new class {
	constructor() {
		this.listeners = [], this.unexpectedErrorHandler = function(e) {
			setTimeout(() => {
				throw e.stack ? ke.isErrorNoTelemetry(e) ? new ke(e.message + "\n\n" + e.stack) : /* @__PURE__ */ Error(e.message + "\n\n" + e.stack) : e;
			}, 0);
		};
	}
	addListener(e) {
...
var Fe = (e, t) => e - t, Ie = class e {
	...
	findLastMaxBy(e) {
		let t, n = !0;
		return this.iterate((r) => ((n || Ne.isGreaterThan(e(r, t))) && (n = !1, t = r), !0)), t;
	}
};
Ie.empty = new Ie((e) => {});
function Le(e, t) {
	...
	computeLeakingDisposables(e = 10, t) {
		...
		for (let t of n.slice(0, e)) {
			...
			for (let t = 0; t < e.length; t++) {
				...
				let o = Le([...i.get(e.slice(0, t).join("\n"))].map((e) => r(e)[t]), (e) => e);
				delete o[e[t]];
...
var Qe = class e {
	constructor() {
		this._toDispose = /* @__PURE__ */ new Set(), this._isDisposed = !1, Ge(this);
	}
	dispose() {
	...
	add(t) {
		...
		return qe(t, this), this._isDisposed ? e.DISABLE_DISPOSED_WARNING || console.warn((/* @__PURE__ */ Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!")).stack) : this._toDispose.add(t), t;
	}
	delete(e) {
		if (e) {
...
}, tt = typeof window == "object" ? window : globalThis, nt = class e {
	constructor(t) {
...
}, it = globalThis.performance && typeof globalThis.performance.now == "function", at = class e {
	static create(t) {
		return new e(t);
	}
	constructor(e) {
		this._now = it && e === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1;
	}
	stop() {
...
((e) => {
	...
	function t(e) {
		if (ct) {
			let { onDidAddListener: t } = e, n = mt.create(), r = 0;
			e.onDidAddListener = () => {
...
if (ot) {
	...
	}, 3e3), xt = new FinalizationRegistry((t) => {
		typeof t == "string" && e.push(t);
	});
}
var N = class {
	constructor(e) {
		this._size = 0, this._options = e, this._leakageMon = dt > 0 || this._options?.leakWarningThreshold ? new pt(e?.onListenerError ?? we, this._options?.leakWarningThreshold ?? dt) : void 0, this._perfMon = this._options?._profName ? new ut(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
	}
	dispose() {
		if (!this._disposed) {
	...
	get event() {
		return this._event ??= (e, t, n) => {
			if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
				...
				console.warn(e);
				let t = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], n = new gt(`${e}. HINT: Stack shows most frequent listener (${t[1]}-times)`, t[0]);
	...
	constructor() {
		this.mapWindowIdToZoomLevel = /* @__PURE__ */ new Map(), this._onDidChangeZoomLevel = new N(), this.onDidChangeZoomLevel = this._onDidChangeZoomLevel.event, this.mapWindowIdToZoomFactor = /* @__PURE__ */ new Map(), this._onDidChangeFullscreen = new N(), this.onDidChangeFullscreen = this._onDidChangeFullscreen.event, this.mapWindowIdToFullScreen = /* @__PURE__ */ new Map();
	}
	getZoomLevel(e) {
...
var Dt = typeof navigator == "object" ? navigator.userAgent : "", Ot = Dt.indexOf("Firefox") >= 0, kt = Dt.indexOf("AppleWebKit") >= 0, At = Dt.indexOf("Chrome") >= 0, jt = !At && Dt.indexOf("Safari") >= 0;
Dt.indexOf("Electron/"), Dt.indexOf("Android");
var Mt = !1;
if (typeof tt.matchMedia == "function") {
	let e = tt.matchMedia("(display-mode: standalone) or (display-mode: window-controls-overlay)"), t = tt.matchMedia("(display-mode: fullscreen)");
	Mt = e.matches, Tt(tt, e, ({ matches: e }) => {
		Mt && t.matches || (Mt = e);
	});
}
function Nt() {
...
var Pt = "en", Ft = !1, It = !1, Lt = !1, Rt = !1, zt = !1, Bt = Pt, Vt, Ht = globalThis, P;
typeof Ht.vscode < "u" && typeof Ht.vscode.process < "u" ? P = Ht.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (P = process);
var Ut = typeof P?.versions?.electron == "string" && P?.type === "renderer";
if (typeof P == "object") {
	Ft = P.platform === "win32", It = P.platform === "darwin", Lt = P.platform === "linux", Lt && P.env.SNAP && P.env.SNAP_REVISION, P.env.CI || P.env.BUILD_ARTIFACTSTAGINGDIRECTORY, Bt = Pt;
	let e = P.env.VSCODE_NLS_CONFIG;
	if (e) try {
		let t = JSON.parse(e);
		t.userLocale, t.osLocale, Bt = t.resolvedLanguage || Pt, t.languagePack?.translationsConfigFile;
	} catch {}
	Rt = !0;
} else typeof navigator == "object" && !Ut ? (Vt = navigator.userAgent, Ft = Vt.indexOf("Windows") >= 0, It = Vt.indexOf("Macintosh") >= 0, (Vt.indexOf("Macintosh") >= 0 || Vt.indexOf("iPad") >= 0 || Vt.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints, Lt = Vt.indexOf("Linux") >= 0, Vt?.indexOf("Mobi"), zt = !0, Bt = globalThis._VSCODE_NLS_LANGUAGE || Pt, navigator.language.toLowerCase()) : console.error("Unable to resolve platform.");
var Wt = Ft, Gt = It, Kt = Lt, qt = Rt;
	...
	if (Zt) {
		...
		return (n) => {
			...
			e.push({
				id: r,
				callback: n
			}), Ht.postMessage({ vscodeScheduleAsyncWork: r }, "*");
		};
	}
	return (e) => setTimeout(e);
})();
var Qt = !!(Jt && Jt.indexOf("Chrome") >= 0);
Jt && Jt.indexOf("Firefox"), !Qt && Jt && Jt.indexOf("Safari"), Jt && Jt.indexOf("Edg/"), Jt && Jt.indexOf("Android");
var $t = typeof navigator == "object" ? navigator : {};
qt || document.queryCommandSupported && document.queryCommandSupported("copy") || $t && $t.clipboard && $t.clipboard.writeText, qt || $t && $t.clipboard && $t.clipboard.readText, qt || Nt() || $t.keyboard, "ontouchstart" in tt || $t.maxTouchPoints, tt.PointerEvent && ("ontouchstart" in tt || navigator.maxTouchPoints);
var en = class {
	constructor() {
...
}, tn = new en(), nn = new en(), rn = new en(), an = Array(230), on;
((e) => {
	function t(e) {
...
var un = Gt ? 256 : 2048, dn = 512, fn = 1024, pn = Gt ? 2048 : 256, mn = class {
	constructor(e) {
	...
	_computeKeybinding() {
		...
		let t = 0;
		return this.ctrlKey && (t |= un), this.altKey && (t |= dn), this.shiftKey && (t |= fn), this.metaKey && (t |= pn), t |= e, t;
	}
	_computeKeyCodeChord() {
		let e = 0;
		return this.keyCode !== 5 && this.keyCode !== 4 && this.keyCode !== 6 && this.keyCode !== 57 && (e = this.keyCode), new sn(this.ctrlKey, this.shiftKey, this.altKey, this.metaKey, e);
	}
	...
	constructor(e, t = 0, n = 0) {
		...
		if (e) {
			...
			if (typeof t.wheelDeltaY < "u") r ? this.deltaY = t.wheelDeltaY / (120 * i) : this.deltaY = t.wheelDeltaY / 120;
				...
				let t = e;
				t.deltaMode === t.DOM_DELTA_LINE ? Ot && !Gt ? this.deltaY = -e.deltaY / 3 : this.deltaY = -e.deltaY : this.deltaY = -e.deltaY / 40;
			}
			if (typeof t.wheelDeltaX < "u") jt && Wt ? this.deltaX = -(t.wheelDeltaX / 120) : r ? this.deltaX = t.wheelDeltaX / (120 * i) : this.deltaX = t.wheelDeltaX / 120;
			else if (typeof n.HORIZONTAL_AXIS < "u" && n.axis === n.HORIZONTAL_AXIS) this.deltaX = -e.detail / 3;
			else if (e.type === "wheel") {
				let t = e;
				t.deltaMode === t.DOM_DELTA_LINE ? Ot && !Gt ? this.deltaX = -e.deltaX / 3 : this.deltaX = -e.deltaX : this.deltaX = -e.deltaX / 40;
			}
...
((e) => {
	function t(t) {
		return t === e.None || t === e.Cancelled || t instanceof Sn ? !0 : !t || typeof t != "object" ? !1 : typeof t.isCancellationRequested == "boolean" && typeof t.onCancellationRequested == "function";
	}
...
var En = class e {
	...
	constructor(e, t) {
		this._state = 0, this._results = [], this._error = null, this._onReturn = t, this._onStateChanged = new N(), queueMicrotask(async () => {
			let t = {
...
function jn(e, t) {
	switch (typeof e) {
		case "object": return e === null ? Mn(349, t) : Array.isArray(e) ? Fn(e, t) : In(e, t);
		case "string": return Pn(e, t);
		case "boolean": return Nn(e, t);
		case "number": return Mn(e, t);
		case "undefined": return Mn(937, t);
		default: return Mn(617, t);
	}
}
function Mn(e, t) {
	return (t << 5) - t + e | 0;
...
function In(e, t) {
	return t = Mn(181387, t), Object.keys(e).sort().reduce((t, n) => (t = Pn(n, t), jn(e[n], t)), t);
}
...
function Bn(e, t = 32) {
	return e instanceof ArrayBuffer ? Array.from(new Uint8Array(e)).map((e) => e.toString(16).padStart(2, "0")).join("") : zn((e >>> 0).toString(16), t / 4);
}
var Vn = class e {
	constructor() {
	...
	digest() {
		return this._finished || (this._finished = !0, this._leftoverHighSurrogate && (this._leftoverHighSurrogate = 0, this._buffLen = this._push(this._buff, this._buffLen, 65533)), this._totalLen += this._buffLen, this._wrapUp()), Bn(this._h0) + Bn(this._h1) + Bn(this._h2) + Bn(this._h3) + Bn(this._h4);
	}
	_wrapUp() {
		this._buff[this._buffLen++] = 128, Rn(this._buff, this._buffLen), this._buffLen > 56 && (this._step(), Rn(this._buff));
	...
	_step() {
		...
		for (let e = 64; e < 320; e += 4) t.setUint32(e, Ln(t.getUint32(e - 12, !1) ^ t.getUint32(e - 32, !1) ^ t.getUint32(e - 56, !1) ^ t.getUint32(e - 64, !1), 1), !1);
		let r = this._h0, i = this._h1, a = this._h2, o = this._h3, s = this._h4, c, l, u;
		for (let e = 0; e < 80; e++) e < 20 ? (c = i & a | ~i & o, l = 1518500249) : e < 40 ? (c = i ^ a ^ o, l = 1859775393) : e < 60 ? (c = i & a | i & o | a & o, l = 2400959708) : (c = i ^ a ^ o, l = 3395469782), u = Ln(r, 5) + c + s + l + t.getUint32(e * 4, !1) & 4294967295, s = o, o = a, a = Ln(i, 30), i = r, r = u;
...
Vn._bigBlock32 = /* @__PURE__ */ new DataView(/* @__PURE__ */ new ArrayBuffer(320));
var { registerWindow: Hn, getWindow: Un, getDocument: Wn, getWindows: Gn, getWindowsCount: Kn, getWindowId: qn, getWindowById: Jn, hasWindow: Yn, onDidRegisterWindow: Xn, onWillUnregisterWindow: Zn, onDidUnregisterWindow: Qn } = function() {
	let e = /* @__PURE__ */ new Map(), t = {
		window: tt,
		disposables: new $e()
	};
	e.set(tt.vscodeWindowId, t);
	let n = new N(), r = new N(), i = new N();
	function a(n, r) {
	...
	return {
		...
		registerWindow(t) {
			...
			let a = new $e(), o = {
				window: t,
				disposables: a.add(new $e())
			};
			return e.set(t.vscodeWindowId, o), a.add(k(() => {
				e.delete(t.vscodeWindowId), r.fire(t);
			})), a.add(F(t, I.BEFORE_UNLOAD, () => {
				i.fire(t);
			})), n.fire(o), a;
		},
		getWindows() {
...
var nr = function(e, t, n, r) {
	let i = n;
	return t === "click" || t === "mousedown" || t === "contextmenu" ? i = er(Un(e), n) : (t === "keydown" || t === "keypress" || t === "keyup") && (i = tr(n)), F(e, t, i, r);
}, rr, ir = class extends wn {
	constructor(e) {
...
(function() {
	let e = /* @__PURE__ */ new Map(), t = /* @__PURE__ */ new Map(), n = /* @__PURE__ */ new Map(), r = /* @__PURE__ */ new Map(), i = (i) => {
		n.set(i, !1);
		let a = e.get(i) ?? [];
		for (t.set(i, a), e.set(i, []), r.set(i, !0); a.length > 0;) a.sort(ar.sort), a.shift().execute();
		r.set(i, !1);
	};
	rr = (t, r, a = 0) => {
		let o = qn(t), s = new ar(r, a), c = e.get(o);
...
or.None = new or(0, 0);
function sr(e) {
	let t = e.getBoundingClientRect(), n = Un(e);
	return {
...
new class {
	...
	observe(e, t, n) {
		...
		let i = An(n), a = r.get(i);
		if (a) a.users += 1;
		else {
			let o = new N(), s = new MutationObserver((e) => o.fire(e));
			s.observe(e, n);
			let c = a = {
				users: 1,
				observer: s,
...
var pr = class {
	...
	startMonitoring(e, t, n, r, i) {
		...
		let a = e;
		try {
			e.setPointerCapture(t), this._hooks.add(k(() => {
				try {
		...
		this._hooks.add(F(a, I.POINTER_MOVE, (e) => {
			if (e.buttons !== n) {
...
var hr;
((e) => (e.Tap = "-xterm-gesturetap", e.Change = "-xterm-gesturechange", e.Start = "-xterm-gesturestart", e.End = "-xterm-gesturesend", e.Contextmenu = "-xterm-gesturecontextmenu"))(hr ||= {});
var gr = class e extends A {
	constructor() {
		super(), this.dispatched = !1, this.targets = new rt(), this.ignoreTargets = new rt(), this.activeTouches = {}, this.handle = null, this._lastSetTapCountTime = 0, this._register(M.runAndSubscribe(Xn, ({ window: e, disposables: t }) => {
			t.add(F(e.document, "touchstart", (e) => this.onTouchStart(e), { passive: !1 })), t.add(F(e.document, "touchend", (t) => this.onTouchEnd(e, t))), t.add(F(e.document, "touchmove", (e) => this.onTouchMove(e), { passive: !1 }));
		}, {
			window: tt,
	...
	static addTarget(t) {
		return e.isTouchDevice() ? (e.INSTANCE ||= Ye(new e()), k(e.INSTANCE.targets.push(t))) : A.None;
	}
	static ignoreTarget(t) {
		return e.isTouchDevice() ? (e.INSTANCE ||= Ye(new e()), k(e.INSTANCE.ignoreTargets.push(t))) : A.None;
	}
	...
	onTouchEnd(t, n) {
		...
		for (let a = 0, o = n.changedTouches.length; a < o; a++) {
			...
			if (c < e.HOLD_DELAY && Math.abs(s.initialPageX - O(s.rollingPageX)) < 30 && Math.abs(s.initialPageY - O(s.rollingPageY)) < 30) {
				let e = this.newGestureEvent(hr.Tap, s.initialTarget);
				e.pageX = O(s.rollingPageX), e.pageY = O(s.rollingPageY), this.dispatchEvent(e);
			} else if (c >= e.HOLD_DELAY && Math.abs(s.initialPageX - O(s.rollingPageX)) < 30 && Math.abs(s.initialPageY - O(s.rollingPageY)) < 30) {
				let e = this.newGestureEvent(hr.Contextmenu, s.initialTarget);
				e.pageX = O(s.rollingPageX), e.pageY = O(s.rollingPageY), this.dispatchEvent(e);
			} else if (i === 1) {
				let e = O(s.rollingPageX), n = O(s.rollingPageY), i = O(s.rollingTimestamps) - s.rollingTimestamps[0], a = e - s.rollingPageX[0], o = n - s.rollingPageY[0], c = [...this.targets].filter((e) => s.initialTarget instanceof Node && e.contains(s.initialTarget));
				this.inertia(t, c, r, Math.abs(a) / i, a > 0 ? 1 : -1, e, Math.abs(o) / i, o > 0 ? 1 : -1, n);
			}
			this.dispatchEvent(this.newGestureEvent(hr.End, s.initialTarget)), delete this.activeTouches[o.identifier];
		}
	...
	onTouchMove(e) {
		...
		for (let n = 0, r = e.changedTouches.length; n < r; n++) {
			...
			let i = this.activeTouches[r.identifier], a = this.newGestureEvent(hr.Change, i.initialTarget);
...
gr.SCROLL_FRICTION = -.005, gr.HOLD_DELAY = 700, gr.CLEAR_TAP_COUNT_TIME = 400, r([mr], gr, "isTouchDevice", 1);
var _r = gr, vr = class extends A {
	onclick(e, t) {
	...
	constructor(e) {
		super(), this._scrollableBrand = void 0, this._onScroll = this._register(new N()), this.onScroll = this._onScroll.event, this._smoothScrollDuration = e.smoothScrollDuration, this._scheduleAtNextAnimationFrame = e.scheduleAtNextAnimationFrame, this._state = new xr(e.forceIntegerValues, 0, 0, 0, 0, 0, 0), this._smoothScrolling = null;
	}
	dispose() {
	...
	setScrollPositionSmooth(e, t) {
		...
		if (this._smoothScrolling) {
			...
			let r;
			r = t ? new Er(this._smoothScrolling.from, n, this._smoothScrolling.startTime, this._smoothScrolling.duration) : this._smoothScrolling.combine(this._state, n, this._smoothScrollDuration), this._smoothScrolling.dispose(), this._smoothScrolling = r;
		} else {
			let t = this._state.withScrollPosition(e);
...
var Er = class e {
	...
	_initAnimation(e, t, n) {
		if (Math.abs(e - t) > 2.5 * n) {
			let r, i;
			return e < t ? (r = e + .75 * n, i = t - .75 * n) : (r = e - .75 * n, i = t + .75 * n), Tr(wr(e, r), wr(i, t), .33);
		}
		return wr(e, t);
	}
	dispose() {
	...
	_tick(e) {
		...
		return t < 1 ? new Cr(this.scrollLeft(t), this.scrollTop(t), !1) : new Cr(this.to.scrollLeft, this.to.scrollTop, !0);
	}
	combine(t, n, r) {
...
var kr = class extends A {
	constructor(e, t, n) {
		super(), this._visibility = e, this._visibleClassName = t, this._invisibleClassName = n, this._domNode = null, this._isVisible = !1, this._isNeeded = !1, this._rawShouldBeVisible = !1, this._shouldBeVisible = !1, this._revealTimer = this._register(new Cn());
	}
	setVisibility(e) {
...
}, Ar = 140, jr = class extends vr {
	constructor(e) {
		super(), this._lazyRender = e.lazyRender, this._host = e.host, this._scrollable = e.scrollable, this._scrollByPage = e.scrollByPage, this._scrollbarState = e.scrollbarState, this._visibilityController = this._register(new kr(e.visibility, "visible scrollbar " + e.extraScrollbarClassName, "invisible scrollbar " + e.extraScrollbarClassName)), this._visibilityController.setIsNeeded(this._scrollbarState.isNeeded()), this._pointerMoveMonitor = this._register(new pr()), this._shouldRender = !0, this.domNode = fr(document.createElement("div")), this.domNode.setAttribute("role", "presentation"), this.domNode.setAttribute("aria-hidden", "true"), this._visibilityController.setDomNode(this.domNode), this.domNode.setPosition("absolute"), this._register(F(this.domNode.domNode, I.POINTER_DOWN, (e) => this._domNodePointerDown(e)));
	}
	_createArrow(e) {
	...
	_createSlider(e, t, n, r) {
		this.slider = fr(document.createElement("div")), this.slider.setClassName("slider"), this.slider.setPosition("absolute"), this.slider.setTop(e), this.slider.setLeft(t), typeof n == "number" && this.slider.setWidth(n), typeof r == "number" && this.slider.setHeight(r), this.slider.setLayerHinting(!0), this.slider.setContain("strict"), this.domNode.domNode.appendChild(this.slider.domNode), this._register(F(this.slider.domNode, I.POINTER_DOWN, (e) => {
	...
	constructor(e, t, n) {
		...
		if (super({
			...
			host: n,
			scrollbarState: new Mr(t.horizontalHasArrows ? t.arrowSize : 0, t.horizontal === 2 ? 0 : t.horizontalScrollbarSize, t.vertical === 2 ? 0 : t.verticalScrollbarSize, r.width, r.scrollWidth, i.scrollLeft),
	...
	constructor(e, t, n) {
		...
		if (super({
			lazyRender: t.lazyRender,
			host: n,
			scrollbarState: new Mr(t.verticalHasArrows ? t.arrowSize : 0, t.vertical === 2 ? 0 : t.verticalScrollbarSize, 0, r.height, r.scrollHeight, i.scrollTop),
...
zr.INSTANCE = new zr();
var Br = zr, Vr = class extends vr {
	constructor(e, t, n) {
		super(), this._onScroll = this._register(new N()), this.onScroll = this._onScroll.event, this._onWillScroll = this._register(new N()), this.onWillScroll = this._onWillScroll.event, this._options = Ur(t), this._scrollable = n, this._register(this._scrollable.onScroll((e) => {
	...
	updateClassName(e) {
		this._options.className = e, Gt && (this._options.className += " mac"), this._domNode.className = "xterm-scrollable-element " + this._options.className;
	}
	updateOptions(e) {
	...
	_setListeningToMouseWheel(e) {
		this._mouseWheelToDispose.length > 0 !== e && (this._mouseWheelToDispose = Xe(this._mouseWheelToDispose), e) && this._mouseWheelToDispose.push(F(this._listenOnDomNode, I.MOUSE_WHEEL, (e) => {
			this._onMouseWheel(new yn(e));
		}, { passive: !1 }));
	}
	_onMouseWheel(e) {
		...
		if (e.deltaY || e.deltaX) {
			...
			if (r) {
				let e = Ir * r, t = o.scrollTop - (e < 0 ? Math.floor(e) : Math.ceil(e));
				this._verticalScrollbar.writeScrollPosition(s, t);
			}
			if (i) {
				let e = Ir * i, t = o.scrollLeft - (e < 0 ? Math.floor(e) : Math.ceil(e));
				this._horizontalScrollbar.writeScrollPosition(s, t);
			}
			s = this._scrollable.validateScrollPosition(s), (o.scrollLeft !== s.scrollLeft || o.scrollTop !== s.scrollTop) && (Lr && this._options.mouseWheelSmoothScroll && t.isPhysicalMouseWheel() ? this._scrollable.setScrollPositionSmooth(s) : this._scrollable.setScrollPositionNow(s), n = !0);
		}
		let r = n;
	...
	_scheduleHide() {
		!this._mouseIsOver && !this._isDragging && this._hideTimeout.cancelAndSet(() => this._hide(), Fr);
	}
}, Hr = class extends Vr {
	constructor(e, t, n) {
		super(e, t, n);
...
function Ur(e) {
	...
	return t.horizontalSliderSize = typeof e.horizontalSliderSize < "u" ? e.horizontalSliderSize : t.horizontalScrollbarSize, t.verticalSliderSize = typeof e.verticalSliderSize < "u" ? e.verticalSliderSize : t.verticalScrollbarSize, Gt && (t.className += " mac"), t;
}
var Wr = class extends A {
	constructor(e, t, n, r, i, a, o, s) {
		super(), this._bufferService = n, this._optionsService = o, this._renderService = s, this._onRequestScrollLines = this._register(new N()), this.onRequestScrollLines = this._onRequestScrollLines.event, this._isSyncing = !1, this._isHandlingScroll = !1, this._suppressOnScrollHandler = !1;
		let c = this._register(new Sr({
		...
		this._register(this._optionsService.onSpecificOptionChange("smoothScrollDuration", () => {
		...
		})), this._scrollableElement = this._register(new Hr(t, {
			vertical: 1,
			horizontal: 2,
			useShadows: !1,
			...
			height: 0,
			scrollHeight: 0
		}), this._register(M.runAndSubscribe(a.onChangeColors, () => {
			this._scrollableElement.getDomNode().style.backgroundColor = a.colors.background.css;
		})), e.appendChild(this._scrollableElement.getDomNode()), this._register(k(() => this._scrollableElement.getDomNode().remove())), this._styleElement = r.mainDocument.createElement("style"), t.appendChild(this._styleElement), this._register(k(() => this._styleElement.remove())), this._register(M.runAndSubscribe(a.onChangeColors, () => {
...
var Gr = class extends A {
	constructor(e, t, n, r, i) {
		...
		})), this._register(this._decorationService.onDecorationRegistered(() => this._queueRefresh())), this._register(this._decorationService.onDecorationRemoved((e) => this._removeDecoration(e))), this._register(k(() => {
...
var Kr = class {
	...
	_refreshDrawConstants() {
		...
		Jr.full = this._canvas.width, Jr.left = e, Jr.center = t, Jr.right = e, this._refreshDrawHeightConstants(), Yr.full = 1, Yr.left = 1, Yr.center = 1 + Jr.left, Yr.right = 1 + Jr.left + Jr.center;
	}
	...
	_refreshColorZonePadding() {
		this._colorZoneStore.setPadding({
			full: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * qr.full),
			left: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * qr.left),
			center: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * qr.center),
			right: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * qr.right)
	...
	_renderColorZone(e) {
		this._ctx.fillStyle = e.color, this._ctx.fillRect(Yr[e.position || "full"], Math.round((this._canvas.height - 1) * (e.startBufferLine / this._bufferService.buffers.active.lines.length) - qr[e.position || "full"] / 2), Jr[e.position || "full"], Math.round((this._canvas.height - 1) * ((e.endBufferLine - e.startBufferLine) / this._bufferService.buffers.active.lines.length) + qr[e.position || "full"]));
	}
	_queueRefresh(e, t) {
...
var R;
((e) => (e.NUL = "\0", e.SOH = "", e.STX = "", e.ETX = "", e.EOT = "", e.ENQ = "", e.ACK = "", e.BEL = "\x07", e.BS = "\b", e.HT = "	", e.LF = "\n", e.VT = "\v", e.FF = "\f", e.CR = "\r", e.SO = "", e.SI = "", e.DLE = "", e.DC1 = "", e.DC2 = "", e.DC3 = "", e.DC4 = "", e.NAK = "", e.SYN = "", e.ETB = "", e.CAN = "", e.EM = "", e.SUB = "", e.ESC = "\x1B", e.FS = "", e.GS = "", e.RS = "", e.US = "", e.SP = " ", e.DEL = ""))(R ||= {});
var Zr;
((e) => (e.PAD = "", e.HOP = "", e.BPH = "", e.NBH = "", e.IND = "", e.NEL = "", e.SSA = "", e.ESA = "", e.HTS = "", e.HTJ = "", e.VTS = "", e.PLD = "", e.PLU = "", e.RI = "", e.SS2 = "", e.SS3 = "", e.DCS = "", e.PU1 = "", e.PU2 = "", e.STS = "", e.CCH = "", e.MW = "", e.SPA = "", e.EPA = "", e.SOS = "", e.SGCI = "", e.SCI = "", e.CSI = "", e.ST = "", e.OSC = "", e.PM = "", e.APC = ""))(Zr ||= {});
var Qr;
((e) => e.ST = `${R.ESC}\\`)(Qr ||= {});
var $r = class {
	constructor(e, t, n, r, i, a) {
...
((e) => {
	...
	e.opaque = i;
	function a(e, t) {
		return H = Math.round(t * 255), [z, B, V] = ti.toChannels(e.rgba), {
			css: U.toCss(z, B, V, H),
...
((e) => {
	...
	function n(e, t, n) {
		...
		if (ri(a, o) < n) {
			if (o < a) {
				let o = r(e, t, n), s = ri(a, K.relativeLuminance(o >> 8));
				if (s < n) {
					let r = i(e, t, n);
			...
			let s = i(e, t, n), c = ri(a, K.relativeLuminance(s >> 8));
			if (c < n) {
				let i = r(e, t, n);
	...
	function r(e, t, n) {
		let r = e >> 24 & 255, i = e >> 16 & 255, a = e >> 8 & 255, o = t >> 24 & 255, s = t >> 16 & 255, c = t >> 8 & 255, l = ri(K.relativeLuminance2(o, s, c), K.relativeLuminance2(r, i, a));
		for (; l < n && (o > 0 || s > 0 || c > 0);) o -= Math.max(0, Math.ceil(o * .1)), s -= Math.max(0, Math.ceil(s * .1)), c -= Math.max(0, Math.ceil(c * .1)), l = ri(K.relativeLuminance2(o, s, c), K.relativeLuminance2(r, i, a));
		return (o << 24 | s << 16 | c << 8 | 255) >>> 0;
	}
	e.reduceLuminance = r;
	function i(e, t, n) {
		let r = e >> 24 & 255, i = e >> 16 & 255, a = e >> 8 & 255, o = t >> 24 & 255, s = t >> 16 & 255, c = t >> 8 & 255, l = ri(K.relativeLuminance2(o, s, c), K.relativeLuminance2(r, i, a));
		for (; l < n && (o < 255 || s < 255 || c < 255);) o = Math.min(255, o + Math.ceil((255 - o) * .1)), s = Math.min(255, s + Math.ceil((255 - s) * .1)), c = Math.min(255, c + Math.ceil((255 - c) * .1)), l = ri(K.relativeLuminance2(o, s, c), K.relativeLuminance2(r, i, a));
		return (o << 24 | s << 16 | c << 8 | 255) >>> 0;
	}
...
var ii = class extends ie {
	...
	constructor(e) {
		this._bufferService = e, this._characterJoiners = [], this._nextCharacterJoinerId = 0, this._workCell = new v();
	}
	register(e) {
		let t = {
	...
	_stringRangesToCellRanges(e, t, n) {
		...
		if (o) {
			for (let s = n; s < this._bufferService.cols; s++) {
				let n = t.getWidth(s), c = t.getString(s).length || re.length;
				if (n !== 0) {
...
var di = class {
	constructor(e, t, n, r, i, a, o) {
		this._document = e, this._characterJoinerService = t, this._optionsService = n, this._coreBrowserService = r, this._coreService = i, this._decorationService = a, this._themeService = o, this._workCell = new v(), this._columnSelectMode = !1, this.defaultSpacing = 0;
	}
	...
	createRow(e, t, n, r, i, a, o, s, c, l, u) {
		...
		n && m < a + 1 && (m = a + 1);
		let h, g = 0, _ = "", ee = 0, te = 0, ne = 0, ae = 0, v = !1, oe = 0, se = !1, ce = 0, le = 0, y = [], ue = l !== -1 && u !== -1;
		for (let b = 0; b < m; b++) {
			e.loadCell(b, this._workCell);
			let m = this._workCell.getWidth();
			if (m === 0) continue;
			let de = !1, fe = b >= le, pe = b, x = this._workCell;
			if (f.length > 0 && b === f[0][0] && fe) {
				...
				fe &&= !n || a < r[0] || a >= r[1], fe ? (de = !0, x = new ii(this._workCell, e.translateToString(!0, r[0], r[1]), r[1] - r[0]), pe = r[1] - 1, m = x.getWidth()) : le = r[1];
			}
			let me = this._isCellInSelection(b, t), S = n && b === a, he = ue && b >= l && b <= u, ge = !1;
			this._decorationService.forEachDecorationAtCell(b, t, void 0, (e) => {
				ge = !0;
			});
			let _e = x.getChars() || re;
			if (_e === " " && (x.isUnderline() || x.isOverline()) && (_e = "\xA0"), ce = m * s - c.get(_e, x.isBold(), x.isItalic()), !h) h = this._document.createElement("span");
			else if (g && (me && se || !me && !se && x.bg === te) && (me && se && p.selectionForeground || x.fg === ne) && x.extended.ext === ae && he === v && ce === oe && !S && !de && !ge && fe) {
				x.isInvisible() ? _ += re : _ += _e, g++;
				continue;
			} else g && (h.textContent = _), h = this._document.createElement("span"), g = 0, _ = "";
			if (te = x.bg, ne = x.fg, ae = x.extended.ext, v = he, oe = ce, se = me, de && a >= b && a <= pe && (a = b), !this._coreService.isCursorHidden && S && this._coreService.isCursorInitialized) {
				if (y.push("xterm-cursor"), this._coreBrowserService.isFocused) o && y.push("xterm-cursor-blink"), y.push(r === "bar" ? "xterm-cursor-bar" : r === "underline" ? "xterm-cursor-underline" : "xterm-cursor-block");
				else if (i) switch (i) {
					case "outline":
			...
			if (x.isBold() && y.push("xterm-bold"), x.isItalic() && y.push("xterm-italic"), x.isDim() && y.push("xterm-dim"), _ = x.isInvisible() ? re : x.getChars() || re, x.isUnderline() && (y.push(`xterm-underline-${x.extended.underlineStyle}`), _ === " " && (_ = "\xA0"), !x.isUnderlineColorDefault())) if (x.isUnderlineColorRGB()) h.style.textDecorationColor = `rgb(${ie.toColorRGB(x.getUnderlineColor()).join(",")})`;
				...
				this._optionsService.rawOptions.drawBoldTextInBrightColors && x.isBold() && e < 8 && (e += 8), h.style.textDecorationColor = p.ansi[e].css;
			}
			x.isOverline() && (y.push("xterm-overline"), _ === " " && (_ = "\xA0")), x.isStrikethrough() && y.push("xterm-strikethrough"), he && (h.style.textDecoration = "underline");
			let C = x.getFgColor(), ve = x.getFgColorMode(), w = x.getBgColor(), T = x.getBgColorMode(), ye = !!x.isInverse();
			if (ye) {
				let e = C;
				C = w, w = e;
				let t = ve;
			...
			let E, be, xe = !1;
			this._decorationService.forEachDecorationAtCell(b, t, void 0, (e) => {
				e.options.layer !== "top" && xe || (e.backgroundColorRGB && (T = 50331648, w = e.backgroundColorRGB.rgba >> 8 & 16777215, E = e.backgroundColorRGB), e.foregroundColorRGB && (ve = 50331648, C = e.foregroundColorRGB.rgba >> 8 & 16777215, be = e.foregroundColorRGB), xe = e.options.layer === "top");
			}), !xe && me && (E = this._coreBrowserService.isFocused ? p.selectionBackgroundOpaque : p.selectionInactiveBackgroundOpaque, w = E.rgba >> 8 & 16777215, T = 50331648, xe = !0, p.selectionForeground && (ve = 50331648, C = p.selectionForeground.rgba >> 8 & 16777215, be = p.selectionForeground)), xe && y.push("xterm-decoration-top");
			let D;
			switch (T) {
				case 16777216:
				case 33554432:
					...
					break;
				case 50331648:
					D = U.toColor(w >> 16, w >> 8 & 255, w & 255), this._addStyle(h, `background-color:#${fi((w >>> 0).toString(16), "0", 6)}`);
					break;
				default: ye ? (D = p.foreground, y.push("xterm-bg-257")) : D = p.background;
			}
			switch (E || x.isDim() && (E = W.multiplyOpacity(D, .5)), ve) {
				case 16777216:
				case 33554432:
					x.isBold() && C < 8 && this._optionsService.rawOptions.drawBoldTextInBrightColors && (C += 8), this._applyMinimumContrast(h, D, p.ansi[C], x, E, void 0) || y.push(`xterm-fg-${C}`);
					break;
				case 50331648:
					let e = U.toColor(C >> 16 & 255, C >> 8 & 255, C & 255);
					this._applyMinimumContrast(h, D, e, x, E, be) || this._addStyle(h, `color:#${fi(C.toString(16), "0", 6)}`);
					break;
				default: this._applyMinimumContrast(h, D, p.foreground, x, E, be) || ye && y.push("xterm-fg-257");
			}
			y.length &&= (h.className = y.join(" "), 0), !S && !de && !ge && fe ? g++ : h.textContent = _, ce !== this.defaultSpacing && (h.style.letterSpacing = `${ce}px`), d.push(h), b = pe;
		}
...
var gi = "xterm-dom-renderer-owner-", _i = "xterm-rows", vi = "xterm-fg-", yi = "xterm-bg-", bi = "xterm-focus", xi = "xterm-selection", Si = 1, Ci = class extends A {
	...
	handleFocus() {
		this._rowContainer.classList.add(bi), this.renderRows(this._bufferService.buffer.y, this._bufferService.buffer.y);
	}
	handleSelectionChanged(e, t, n) {
...
var wi = class extends A {
	constructor(e, t, n) {
		super(), this._optionsService = n, this.width = 0, this.height = 0, this._onCharSizeChange = this._register(new N()), this.onCharSizeChange = this._onCharSizeChange.event;
		try {
...
var Ti = class extends A {
	...
	_setWindowResizeListener() {
		this._windowResizeListener.value = F(this._parentWindow, "resize", () => this._setDprAndFireIfDiffers());
	}
	...
	constructor() {
		super(), this.linkProviders = [], this._register(k(() => this.linkProviders.length = 0));
	}
...
var Ni = class {
	...
	getCoords(e, t, n, r, i) {
		return Mi(window, e, t, n, r, this._charSizeService.hasValidSize, this._renderService.dimensions.css.cell.width, this._renderService.dimensions.css.cell.height, i);
	}
...
var Ii = typeof process < "u" && "title" in process, Li = Ii ? "node" : navigator.userAgent, Ri = Ii ? "node" : navigator.platform, zi = Li.includes("Firefox"), Bi = Li.includes("Edge"), Vi = /^((?!chrome|android).)*safari/i.test(Li);
function Hi() {
	if (!Vi) return 0;
...
var Ui = [
	...
	"MacPPC",
	"Mac68K"
].includes(Ri), Wi = Ri === "iPad", Gi = Ri === "iPhone", Ki = [
	"Windows",
	"Win16",
	"Win32",
	"WinCE"
].includes(Ri), qi = Ri.indexOf("Linux") >= 0, Ji = /\bCrOS\b/.test(Li), Yi = class {
	constructor() {
...
}, Qi = !Ii && "requestIdleCallback" in window ? Zi : Xi, $i = class {
	constructor() {
		this._queue = new Qi();
	}
	set(e) {
...
function ua(e, t, n, r, i, a) {
	let o;
	return o = oa(n, r, i, a).length > 0 ? r - la(r, i) : t, e < n && o <= r || e >= n && o < r ? "C" : "D";
}
function da(e, t) {
	return e > t ? "A" : "B";
}
...
var _a = 50, va = 15, ya = 50, ba = 500, xa = /* @__PURE__ */ RegExp("\xA0", "g"), Sa = class extends A {
	constructor(e, t, n, r, i, a, o, s, c) {
		...
		}), this._trimListener = this._bufferService.buffer.lines.onTrim((e) => this._handleTrim(e)), this._register(this._bufferService.buffers.onBufferActivate((e) => this._handleBufferActivate(e))), this.enable(), this._model = new ha(this._bufferService), this._activeSelectionMode = 0, this._register(k(() => {
	...
	get selectionText() {
		...
		return r.map((e) => e.replace(xa, " ")).join(Ki ? "\r\n" : "\n");
	}
	clearSelection() {
		this._model.clearSelection(), this._removeMouseDownListeners(), this.refresh(), this._onSelectionChange.fire();
	}
	refresh(e) {
		this._refreshAnimationFrame ||= this._coreBrowserService.window.requestAnimationFrame(() => this._refresh()), qi && e && this.selectionText.length && this._onLinuxMouseSelection.fire(this.selectionText);
	}
	_refresh() {
	...
	_selectWordAtCursor(e, t) {
		...
		if (n) return this._model.selectionStart = [n.start.x - 1, n.start.y - 1], this._model.selectionStartLength = ga(n, this._bufferService.cols), this._model.selectionEnd = void 0, !0;
	...
	_getMouseEventScrollAmount(e) {
		let t = ji(this._coreBrowserService.window, e, this._screenElement)[1], n = this._renderService.dimensions.css.canvas.height;
		return t >= 0 && t <= n ? 0 : (t > n && (t -= n), t = Math.min(Math.max(t, -_a), _a), t /= _a, t / Math.abs(t) + Math.round(t * (va - 1)));
	}
	shouldForceSelection(e) {
		return Ui ? e.altKey && this._optionsService.rawOptions.macOptionClickForcesSelection : e.shiftKey;
	}
	handleMouseDown(e) {
	...
	_addMouseDownListeners() {
		this._screenElement.ownerDocument && (this._screenElement.ownerDocument.addEventListener("mousemove", this._mouseMoveListener), this._screenElement.ownerDocument.addEventListener("mouseup", this._mouseUpListener)), this._dragScrollIntervalTimer = this._coreBrowserService.window.setInterval(() => this._dragScroll(), ya);
	}
	...
	_handleMouseUp(e) {
		...
		if (this._removeMouseDownListeners(), this.selectionText.length <= 1 && t < ba && e.altKey && this._optionsService.rawOptions.altClickMovesCursor) {
			if (this._bufferService.buffer.ybase === this._bufferService.buffer.ydisp) {
				...
				if (t && t[0] !== void 0 && t[1] !== void 0) {
					let e = na(t[0] - 1, t[1] - 1, this._bufferService, this._coreService.decPrivateModes.applicationCursorKeys);
					this._coreService.triggerDataEvent(e, !0);
				}
			}
	...
	_selectLineAt(e) {
		...
		this._model.selectionStart = [0, t.first], this._model.selectionEnd = void 0, this._model.selectionStartLength = ga(n, this._bufferService.cols);
	}
};
Sa = r([
	i(3, b),
...
var Ca = class {
	...
	return e;
})()), Ta = G.toColor("#ffffff"), Ea = G.toColor("#000000"), Da = G.toColor("#ffffff"), Oa = Ea, ka = {
	css: "rgba(255, 255, 255, 0.3)",
	rgba: 4294967117
}, Aa = Ta, ja = class extends A {
	constructor(e) {
		super(), this._optionsService = e, this._contrastCache = new wa(), this._halfContrastCache = new wa(), this._onChangeColors = this._register(new N()), this.onChangeColors = this._onChangeColors.event, this._colors = {
			foreground: Ta,
			background: Ea,
			cursor: Da,
			cursorAccent: Oa,
			...
			scrollbarSliderBackground: W.opacity(Ta, .2),
			scrollbarSliderHoverBackground: W.opacity(Ta, .4),
			scrollbarSliderActiveBackground: W.opacity(Ta, .5),
...
var Ma = class {
	...
	createInstance(e, ...t) {
		let n = le(e).sort((e, t) => e.index - t.index), r = [];
		for (let t of n) {
	...
	error: 4,
	off: 5
}, Fa = "xterm.js: ", Ia = class extends A {
	constructor(e) {
		super(), this._optionsService = e, this._logLevel = 5, this._updateLogLevel(), this._register(this._optionsService.onSpecificOptionChange("logLevel", () => this._updateLogLevel())), La = this;
	}
	get logLevel() {
	...
	_log(e, t, n) {
		this._evalLazyOptionalParams(n), e.call(console, (this._optionsService.options.logger ? "" : Fa) + t, ...n);
	}
	trace(e, ...t) {
...
Ia = r([i(0, S)], Ia);
var La, Ra = class extends A {
	constructor(e) {
		super(), this._maxLength = e, this.onDeleteEmitter = this._register(new N()), this.onDelete = this.onDeleteEmitter.event, this.onInsertEmitter = this._register(new N()), this.onInsert = this.onInsertEmitter.event, this.onTrimEmitter = this._register(new N()), this.onTrim = this.onTrimEmitter.event, this._array = Array(this._maxLength), this._startIndex = 0, this._length = 0;
	}
	get maxLength() {
...
}, Y = 3, X = Object.freeze(new ie()), za = 0, Ba = 2, Va = class e {
	constructor(e, t, n = !1) {
		this.isWrapped = n, this._combined = {}, this._extendedAttrs = {}, this._data = new Uint32Array(e * Y);
		let r = t || v.fromCharData([
			0,
			ne,
			1,
			0
	...
	get(e) {
		let t = this._data[e * Y + 0], n = t & 2097151;
		return [
			this._data[e * Y + 1],
	...
	set(e, t) {
		this._data[e * Y + 1] = t[0], t[1].length > 1 ? (this._combined[e] = t[1], this._data[e * Y + 0] = e | 2097152 | t[2] << 22) : this._data[e * Y + 0] = t[1].charCodeAt(0) | t[2] << 22;
	}
	getWidth(e) {
	...
	loadCell(e, t) {
		return za = e * Y, t.content = this._data[za + 0], t.fg = this._data[za + 1], t.bg = this._data[za + 2], t.content & 2097152 && (t.combinedData = this._combined[e]), t.bg & 268435456 && (t.extended = this._extendedAttrs[e]), t;
	}
	setCell(e, t) {
		t.content & 2097152 && (this._combined[e] = t.combinedData), t.bg & 268435456 && (this._extendedAttrs[e] = t.extended), this._data[e * Y + 0] = t.content, this._data[e * Y + 1] = t.fg, this._data[e * Y + 2] = t.bg;
	}
	setCellFromCodepoint(e, t, n, r) {
		r.bg & 268435456 && (this._extendedAttrs[e] = r.extended), this._data[e * Y + 0] = t | n << 22, this._data[e * Y + 1] = r.fg, this._data[e * Y + 2] = r.bg;
	}
	addCodepointToCell(e, t, n) {
		let r = this._data[e * Y + 0];
		r & 2097152 ? this._combined[e] += g(t) : r & 2097151 ? (this._combined[e] = g(r & 2097151) + g(t), r &= -2097152, r |= 2097152) : r = t | 1 << 22, n && (r &= -12582913, r |= n << 22), this._data[e * Y + 0] = r;
	}
	insertCells(e, t, n) {
	...
	getTrimmedLength() {
		for (let e = this.length - 1; e >= 0; --e) if (this._data[e * Y + 0] & 4194303) return e + (this._data[e * Y + 0] >> 22);
		return 0;
	}
	getNoBgTrimmedLength() {
		for (let e = this.length - 1; e >= 0; --e) if (this._data[e * Y + 0] & 4194303 || this._data[e * Y + 2] & 50331648) return e + (this._data[e * Y + 0] >> 22);
		return 0;
	}
	...
	translateToString(e, t, n, r) {
		...
		let i = "";
		for (; t < n;) {
			let e = this._data[t * Y + 0], n = e & 2097151, a = e & 2097152 ? this._combined[t] : n ? g(n) : re;
...
function Ha(e, t, n, r, i, a) {
	...
	for (let s = 0; s < e.length - 1; s++) {
		...
		let d = 0, f = Ka(u, d, t), p = 1, m = 0;
		for (; p < u.length;) {
			let e = Ka(u, p, t), r = e - m, a = n - f, o = Math.min(r, a);
...
function Ga(e, t, n) {
	let r = [], i = e.map((n, r) => Ka(e, r, t)).reduce((e, t) => e + t), a = 0, o = 0, s = 0;
	for (; s < i;) {
		if (i - s < n) {
			r.push(i - s);
			break;
...
var qa = class e {
	constructor(t) {
		this.line = t, this.isDisposed = !1, this._disposables = [], this._id = e._nextId++, this._onDispose = this.register(new N()), this.onDispose = this._onDispose.event;
	}
	get id() {
		return this._id;
	}
	dispose() {
		this.isDisposed || (this.isDisposed = !0, this.line = -1, this._onDispose.fire(), Xe(this._disposables), this._disposables.length = 0);
	}
	register(e) {
...
var Xa = 4294967295, Za = class {
	constructor(e, t, n) {
		this._hasScrollback = e, this._optionsService = t, this._bufferService = n, this.ydisp = 0, this.ybase = 0, this.y = 0, this.x = 0, this.tabs = {}, this.savedY = 0, this.savedX = 0, this.savedCurAttrData = X.clone(), this.savedCharset = Ya, this.markers = [], this._nullCell = v.fromCharData([
			0,
			ne,
			1,
			0
		]), this._whitespaceCell = v.fromCharData([
			0,
			re,
			1,
			32
		]), this._isClearing = !1, this._memoryCleanupQueue = new Qi(), this._memoryCleanupPosition = 0, this._cols = this._bufferService.cols, this._rows = this._bufferService.rows, this.lines = new Ra(this._getCorrectBufferLength(this._rows)), this.scrollTop = 0, this.scrollBottom = this._rows - 1, this.setupTabStops();
	}
	getNullCell(e) {
		return e ? (this._nullCell.fg = e.fg, this._nullCell.bg = e.bg, this._nullCell.extended = e.extended) : (this._nullCell.fg = 0, this._nullCell.bg = 0, this._nullCell.extended = new ae()), this._nullCell;
	}
	getWhitespaceCell(e) {
		return e ? (this._whitespaceCell.fg = e.fg, this._whitespaceCell.bg = e.bg, this._whitespaceCell.extended = e.extended) : (this._whitespaceCell.fg = 0, this._whitespaceCell.bg = 0, this._whitespaceCell.extended = new ae()), this._whitespaceCell;
	}
	getBlankLine(e, t) {
	...
	clear() {
		this.ydisp = 0, this.ybase = 0, this.y = 0, this.x = 0, this.lines = new Ra(this._getCorrectBufferLength(this._rows)), this.scrollTop = 0, this.scrollBottom = this._rows - 1, this.setupTabStops();
	}
	resize(e, t) {
		let n = this.getNullCell(X), r = 0, i = this._getCorrectBufferLength(t);
		if (i > this.lines.maxLength && (this.lines.maxLength = i), this.lines.length > 0) {
			...
			let a = 0;
			if (this._rows < t) for (let r = this._rows; r < t; r++) this.lines.length < t + this.ybase && (this._optionsService.rawOptions.windowsMode || this._optionsService.rawOptions.windowsPty.backend !== void 0 || this._optionsService.rawOptions.windowsPty.buildNumber !== void 0 ? this.lines.push(new Va(e, n)) : this.ybase > 0 && this.lines.length <= this.ybase + this.y + a + 1 ? (this.ybase--, a++, this.ydisp > 0 && this.ydisp--) : this.lines.push(new Va(e, n)));
	...
	_reflowLarger(e, t) {
		let n = this._optionsService.rawOptions.reflowCursorLine, r = Ha(this.lines, this._cols, e, this.ybase + this.y, this.getNullCell(X), n);
		if (r.length > 0) {
	...
	_reflowLargerAdjustViewport(e, t, n) {
		let r = this.getNullCell(X), i = n;
		for (; i-- > 0;) this.ybase === 0 ? (this.y > 0 && this.y--, this.lines.length < t && this.lines.push(new Va(e, r))) : (this.ydisp === this.ybase && this.ydisp--, this.ybase--);
		this.savedY = Math.max(this.savedY - n, 0);
	}
	_reflowSmaller(e, t) {
		let n = this._optionsService.rawOptions.reflowCursorLine, r = this.getNullCell(X), i = [], a = 0;
		for (let o = this.lines.length - 1; o >= 0; o--) {
			...
			let l = c[c.length - 1].getTrimmedLength(), u = Ga(c, this._cols, e), d = u.length - c.length, f;
			...
			for (; g >= 0;) {
				let e = Math.min(_, h);
				if (c[m] === void 0) break;
				c[m].copyCellsFrom(c[g], _ - e, h - e, e, !0), h -= e, h === 0 && (m--, h = u[m]), _ -= e, _ === 0 && (g--, _ = Ka(c, Math.max(g, 0), this._cols));
			}
			for (let t = 0; t < c.length; t++) u[t] < e && c[t].setCell(u[t], r);
			let ee = d - f;
			for (; ee-- > 0;) this.ybase === 0 ? this.y < t - 1 ? (this.y++, this.lines.pop()) : (this.ybase++, this.ydisp++) : this.ybase < Math.min(this.lines.maxLength, this.lines.length + a) - t && (this.ybase === this.ydisp && this.ydisp++, this.ybase++);
	...
	reset() {
		this._normal = new Za(!0, this._optionsService, this._bufferService), this._normal.fillViewportRows(), this._alt = new Za(!1, this._optionsService, this._bufferService), this._activeBuffer = this._normal, this._onBufferActivate.fire({
...
}, $a = 2, eo = 1, to = class extends A {
	constructor(e) {
		super(), this.isUserScrolling = !1, this._onResize = this._register(new N()), this.onResize = this._onResize.event, this._onScroll = this._register(new N()), this.onScroll = this._onScroll.event, this.cols = Math.max(e.rawOptions.cols || 0, $a), this.rows = Math.max(e.rawOptions.rows || 0, eo), this.buffers = this._register(new Qa(e, this)), this._register(this.buffers.onBufferActivate((e) => {
...
var no = {
	...
	constructor(e) {
		super(), this._onOptionChange = this._register(new N()), this.onOptionChange = this._onOptionChange.event;
		let t = { ...no };
		...
		this.rawOptions = t, this.options = { ...t }, this._setupOptions(), this._register(k(() => {
...
var so = Object.freeze({ insertMode: !1 }), co = Object.freeze({
	...
	constructor(e, t, n) {
		super(), this._bufferService = e, this._logService = t, this._optionsService = n, this.isCursorInitialized = !1, this.isCursorHidden = !1, this._onData = this._register(new N()), this.onData = this._onData.event, this._onUserInput = this._register(new N()), this.onUserInput = this._onUserInput.event, this._onBinary = this._register(new N()), this.onBinary = this._onBinary.event, this._onRequestScrollToBottom = this._register(new N()), this.onRequestScrollToBottom = this._onRequestScrollToBottom.event, this.modes = oo(so), this.decPrivateModes = oo(co);
	}
	reset() {
...
var po = String.fromCharCode, mo = {
	DEFAULT: (e) => {
		...
		return t[0] > 255 || t[1] > 255 || t[2] > 255 ? "" : `\x1B[M${po(t[0])}${po(t[1])}${po(t[2])}`;
	},
	SGR: (e) => {
	...
	constructor(e, t, n) {
		super(), this._bufferService = e, this._coreService = t, this._optionsService = n, this._protocols = {}, this._encodings = {}, this._activeProtocol = "", this._activeEncoding = "", this._lastEvent = null, this._wheelPartialScroll = 0, this._onProtocolChange = this._register(new N()), this.onProtocolChange = this._onProtocolChange.event;
...
var yo = class {
	...
	wcwidth(e) {
		return e < 32 ? 0 : e < 127 ? 1 : e < 65536 ? Q[e] : vo(e, _o) ? 0 : e >= 131072 && e <= 196605 || e >= 196608 && e <= 262141 ? 2 : 1;
	}
	charProperties(e, t) {
	...
	constructor() {
		this._providers = Object.create(null), this._active = "", this._onChange = new N(), this.onChange = this._onChange.event;
		let e = new yo();
...
var Co = 2147483647, wo = 256, To = class e {
	constructor(e = 32, t = 32) {
		if (this.maxLength = e, this.maxSubParamsLength = t, t > wo) throw Error("maxSubParamsLength must not be greater than 256");
	...
	addParam(e) {
		...
		this._subParamsIdx[this.length] = this._subParamsLength << 8 | this._subParamsLength, this.params[this.length++] = e > Co ? Co : e;
	}
	addSubParam(e) {
		if (this._digitIsSub = !0, this.length) {
			...
			if (e < -1) throw Error("values lesser than -1 are not allowed");
			this._subParams[this._subParamsLength++] = e > Co ? Co : e, this._subParamsIdx[this.length - 1]++;
		}
	}
	hasSubParams(e) {
	...
	constructor() {
		this._state = 0, this._active = Eo, this._id = -1, this._handlers = Object.create(null), this._handlerFb = () => {}, this._stack = {
			paused: !1,
			loopPosition: 0,
			fallThrough: !1
		};
	...
	_start() {
		if (this._active = this._handlers[this._id] || Eo, !this._active.length) this._handlerFb(this._id, "START");
	...
	put(e, t, n) {
		this._hitLimit || (this._data += _(e, t, n), this._data.length > 1e7 && (this._data = "", this._hitLimit = !0));
	}
	end(e) {
		let t = !1;
	...
	constructor() {
		this._handlers = Object.create(null), this._active = ko, this._ident = 0, this._handlerFb = () => {}, this._stack = {
			paused: !1,
			loopPosition: 0,
			fallThrough: !1
		};
	...
	hook(e, t) {
		if (this.reset(), this._ident = e, this._active = this._handlers[e] || ko, !this._active.length) this._handlerFb(this._ident, "HOOK", t);
...
var Mo = class {
	...
	hook(e) {
		this._params = e.length > 1 || e.params[0] ? e.clone() : jo, this._data = "", this._hitLimit = !1;
	}
	put(e, t, n) {
		this._hitLimit || (this._data += _(e, t, n), this._data.length > 1e7 && (this._data = "", this._hitLimit = !0));
	}
	unhook(e) {
		let t = !1;
		if (this._hitLimit) t = !1;
		else if (e && (t = this._handler(this._data, this._params), t instanceof Promise)) return t.then((e) => (this._params = jo, this._data = "", this._hitLimit = !1, e));
	...
	let e = new No(4095), t = Array.apply(null, Array(256)).map((e, t) => t), n = (e, n) => t.slice(e, n), r = n(32, 127), i = n(0, 24);
	...
	return e.addMany(i, 0, 3, 0), e.addMany(i, 1, 3, 1), e.add(127, 1, 0, 1), e.addMany(i, 8, 0, 8), e.addMany(i, 3, 3, 3), e.add(127, 3, 0, 3), e.addMany(i, 4, 3, 4), e.add(127, 4, 0, 4), e.addMany(i, 6, 3, 6), e.addMany(i, 5, 3, 5), e.add(127, 5, 0, 5), e.addMany(i, 2, 3, 2), e.add(127, 2, 0, 2), e.add(93, 1, 4, 8), e.addMany(r, 8, 5, 8), e.add(127, 8, 5, 8), e.addMany([
		...
		24,
		26
	], 13, 14, 0), e.add(Po, 0, 2, 0), e.add(Po, 8, 5, 8), e.add(Po, 6, 0, 6), e.add(Po, 11, 0, 11), e.add(Po, 13, 13, 13), e;
}(), Io = class extends A {
	constructor(e = Fo) {
		super(), this._transitions = e, this._parseStack = {
			...
			transition: 0,
			chunkPos: 0
		}, this.initialState = 0, this.currentState = this.initialState, this._params = new To(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0, this._printHandlerFb = (e, t, n) => {}, this._executeHandlerFb = (e) => {}, this._csiHandlerFb = (e, t) => {}, this._escHandlerFb = (e) => {}, this._errorHandlerFb = (e) => e, this._printHandler = this._printHandlerFb, this._executeHandlers = Object.create(null), this._csiHandlers = Object.create(null), this._escHandlers = Object.create(null), this._register(k(() => {
			this._csiHandlers = Object.create(null), this._executeHandlers = Object.create(null), this._escHandlers = Object.create(null);
		})), this._oscParser = this._register(new Do()), this._dcsParser = this._register(new Ao()), this._errorHandler = this._errorHandlerFb, this.registerEscHandler({ final: "\\" }, () => !0);
	}
	...
	parse(e, t, n) {
		...
		for (let n = a; n < t; ++n) {
			switch (r = e[n], i = this._transitions.table[this.currentState << 8 | (r < 160 ? r : Po)], i >> 4) {
				case 2:
					for (let i = n + 1;; ++i) {
				...
				case 12:
					...
					break;
				case 13:
					for (let i = n + 1;; ++i) if (i >= t || (r = e[i]) === 24 || r === 26 || r === 27 || r > 127 && r < Po) {
				...
				case 4:
					...
					break;
				case 5:
					for (let i = n + 1;; i++) if (i >= t || (r = e[i]) < 32 || r > 127 && r < Po) {
...
}, Lo = /^([\da-f])\/([\da-f])\/([\da-f])$|^([\da-f]{2})\/([\da-f]{2})\/([\da-f]{2})$|^([\da-f]{3})\/([\da-f]{3})\/([\da-f]{3})$|^([\da-f]{4})\/([\da-f]{4})\/([\da-f]{4})$/, Ro = /^[\da-f]+$/;
function zo(e) {
	if (!e) return;
	let t = e.toLowerCase();
	if (t.indexOf("rgb:") === 0) {
	...
	} else if (t.indexOf("#") === 0 && (t = t.slice(1), Ro.exec(t) && [
		3,
		6,
		9,
		12
...
var Ko = 5e3, qo = 0, Jo = class extends A {
	constructor(e, t, n, r, i, a, o, s, c = new Io()) {
		super(), this._bufferService = e, this._charsetService = t, this._coreService = n, this._logService = r, this._optionsService = i, this._oscLinkService = a, this._coreMouseService = o, this._unicodeService = s, this._parser = c, this._parseBuffer = new Uint32Array(4096), this._stringDecoder = new ee(), this._utf8Decoder = new te(), this._windowTitle = "", this._iconName = "", this._windowTitleStack = [], this._iconNameStack = [], this._curAttrData = X.clone(), this._eraseAttrDataInternal = X.clone(), this._onRequestBell = this._register(new N()), this.onRequestBell = this._onRequestBell.event, this._onRequestRefreshRows = this._register(new N()), this.onRequestRefreshRows = this._onRequestRefreshRows.event, this._onRequestReset = this._register(new N()), this.onRequestReset = this._onRequestReset.event, this._onRequestSendFocus = this._register(new N()), this.onRequestSendFocus = this._onRequestSendFocus.event, this._onRequestSyncScrollBar = this._register(new N()), this.onRequestSyncScrollBar = this._onRequestSyncScrollBar.event, this._onRequestWindowsOptionsReport = this._register(new N()), this.onRequestWindowsOptionsReport = this._onRequestWindowsOptionsReport.event, this._onA11yChar = this._register(new N()), this.onA11yChar = this._onA11yChar.event, this._onA11yTab = this._register(new N()), this.onA11yTab = this._onA11yTab.event, this._onCursorMove = this._register(new N()), this.onCursorMove = this._onCursorMove.event, this._onLineFeed = this._register(new N()), this.onLineFeed = this._onLineFeed.event, this._onScroll = this._register(new N()), this.onScroll = this._onScroll.event, this._onTitleChange = this._register(new N()), this.onTitleChange = this._onTitleChange.event, this._onColor = this._register(new N()), this.onColor = this._onColor.event, this._parseStack = {
			...
			257,
			258
		], this._register(this._parser), this._dirtyRowTracker = new Yo(this._bufferService), this._activeBuffer = this._bufferService.buffer, this._register(this._bufferService.buffers.onBufferActivate((e) => this._activeBuffer = e.activeBuffer)), this._parser.setCsiHandlerFallback((e, t) => {
		...
		for (let e in Z) this._parser.registerEscHandler({
			intermediates: "(",
			final: e
	...
	_logSlowResolvingAsync(e) {
		this._logService.logLevel <= 3 && Promise.race([e, new Promise((e, t) => setTimeout(() => t("#SLOW_TIMEOUT"), Ko))]).catch((e) => {
	...
	print(e, t, n) {
		...
		for (let p = t; p < n; ++p) {
			...
			i = bo.extractWidth(t);
			let n = bo.extractShouldJoin(t), m = n ? bo.extractWidth(f) : 0;
			if (f = t, o && this._onA11yChar.fire(g(r)), this._getCurrentLinkId() && this._oscLinkService.addLineToLink(this._getCurrentLinkId(), this._activeBuffer.ybase + this._activeBuffer.y), this._activeBuffer.x + i - m > s) {
				if (c) {
	...
	registerCsiHandler(e, t) {
		return e.final === "t" && !e.prefix && !e.intermediates ? this._parser.registerCsiHandler(e, (e) => Go(e.params[0], this._optionsService.rawOptions.windowOptions) ? t(e) : !0) : this._parser.registerCsiHandler(e, t);
	}
	registerDcsHandler(e, t) {
	...
	scrollDown(e) {
		let t = e.params[0] || 1;
		for (; t--;) this._activeBuffer.lines.splice(this._activeBuffer.ybase + this._activeBuffer.scrollBottom, 1), this._activeBuffer.lines.splice(this._activeBuffer.ybase + this._activeBuffer.scrollTop, 0, this._activeBuffer.getBlankLine(X));
		return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.scrollTop, this._activeBuffer.scrollBottom), !0;
	}
	scrollLeft(e) {
		if (this._activeBuffer.y > this._activeBuffer.scrollBottom || this._activeBuffer.y < this._activeBuffer.scrollTop) return !0;
	...
	repeatPrecedingCharacter(e) {
		...
		if (!t) return !0;
		let n = e.params[0] || 1, r = bo.extractWidth(t), i = this._activeBuffer.x - r, a = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y).getString(i), o = new Uint32Array(a.length * n), s = 0;
	...
	setModePrivate(e) {
		for (let t = 0; t < e.length; t++) switch (e.params[t]) {
			case 1:
				...
				break;
			case 2:
				this._charsetService.setgCharset(0, Ya), this._charsetService.setgCharset(1, Ya), this._charsetService.setgCharset(2, Ya), this._charsetService.setgCharset(3, Ya);
				break;
			case 3:
	...
	_updateAttrColor(e, t, n, r, i) {
		return t === 2 ? (e |= 50331648, e &= -16777216, e |= ie.fromColorRGB([
			n,
			r,
			i
	...
	windowOptions(e) {
		...
		switch (e.params[0]) {
			...
			case 18:
				...
				break;
			case 22:
				(t === 0 || t === 2) && (this._windowTitleStack.push(this._windowTitle), this._windowTitleStack.length > Wo && this._windowTitleStack.shift()), (t === 0 || t === 1) && (this._iconNameStack.push(this._iconName), this._iconNameStack.length > Wo && this._iconNameStack.shift());
				break;
			case 23:
	...
	selectCharset(e) {
		return e.length === 2 ? (e[0] === "/" || this._charsetService.setgCharset(Ho[e[0]], Z[e[1]] || Ya), !0) : (this.selectDefaultCharset(), !0);
	}
	index() {
	...
	markRangeDirty(e, t) {
		e > t && (qo = e, e = t, t = qo), e < this.start && (this.start = e), t > this.end && (this.end = t);
	}
	markAllDirty() {
...
var Zo = 5e7, Qo = 12, $o = 50, es = class extends A {
	constructor(e) {
		super(), this._action = e, this._writeBuffer = [], this._callbacks = [], this._pendingData = 0, this._bufferOffset = 0, this._isSyncWriting = !1, this._syncCalls = 0, this._didUserInput = !1, this._onWriteParsed = this._register(new N()), this.onWriteParsed = this._onWriteParsed.event;
	}
	handleUserInput() {
	...
	write(e, t) {
		if (this._pendingData > Zo) throw Error("write data discarded, use flow control to avoid losing data");
		...
		for (; this._writeBuffer.length > this._bufferOffset;) {
			...
			if (r) {
				r.catch((e) => (queueMicrotask(() => {
					throw e;
				}), Promise.resolve(!1))).then((e) => performance.now() - n >= Qo ? setTimeout(() => this._innerWrite(0, e)) : this._innerWrite(n, e));
				return;
			}
			let i = this._callbacks[this._bufferOffset];
			if (i && i(), this._bufferOffset++, this._pendingData -= e.length, performance.now() - n >= Qo) break;
		}
		this._writeBuffer.length > this._bufferOffset ? (this._bufferOffset > $o && (this._writeBuffer = this._writeBuffer.slice(this._bufferOffset), this._callbacks = this._callbacks.slice(this._bufferOffset), this._bufferOffset = 0), setTimeout(() => this._innerWrite())) : (this._writeBuffer.length = 0, this._callbacks.length = 0, this._pendingData = 0, this._bufferOffset = 0), this._onWriteParsed.fire();
	}
}, ts = class {
	constructor(e) {
...
var ns = !1, rs = class extends A {
	...
	get onScroll() {
		return this._onScrollApi || (this._onScrollApi = this._register(new N()), this._onScroll.event((e) => {
	...
	writeSync(e, t) {
		this._logService.logLevel <= 3 && !ns && (this._logService.warn("writeSync is unreliable and will be removed soon."), ns = !0), this._writeBuffer.writeSync(e, t);
	}
	input(e, t = !0) {
		this.coreService.triggerDataEvent(e, t);
	}
	resize(e, t) {
		isNaN(e) || isNaN(t) || (e = Math.max(e, $a), t = Math.max(t, eo), this._bufferService.resize(e, t));
	}
	scroll(e, t = !1) {
	...
	_enableWindowsWrappingHeuristics() {
		if (!this._windowsWrappingHeuristics.value) {
			let e = [];
			e.push(this.onLineFeed(So.bind(null, this._bufferService))), e.push(this.registerCsiHandler({ final: "H" }, () => (So(this._bufferService), !1))), this._windowsWrappingHeuristics.value = k(() => {
...
var $ = 0, os = class {
	constructor(e) {
		this._getKey = e, this._array = [], this._insertedValues = [], this._flushInsertedTask = new Qi(), this._isFlushingInserted = !1, this._deletedIndices = [], this._flushDeletedTask = new Qi(), this._isFlushingDeleted = !1;
	}
	clear() {
...
}, ss = 0, cs = 0, ls = class extends A {
	constructor() {
		super(), this._decorations = new os((e) => e?.marker.line), this._onDecorationRegistered = this._register(new N()), this.onDecorationRegistered = this._onDecorationRegistered.event, this._onDecorationRemoved = this._register(new N()), this.onDecorationRemoved = this._onDecorationRemoved.event, this._register(k(() => this.reset()));
	}
	get decorations() {
	...
	*getDecorationsAtCell(e, t, n) {
	...
	forEachDecorationAtCell(e, t, n, r) {
		this._decorations.forEachByKey(t, (t) => {
			ss = t.options.x ?? 0, cs = ss + (t.options.width ?? 1), e >= ss && e < cs && (!n || (t.options.layer ?? "bottom") === n) && r(t);
		});
	}
}, us = class extends $e {
	constructor(e) {
		super(), this.options = e, this.onRenderEmitter = this.add(new N()), this.onRender = this.onRenderEmitter.event, this._onDispose = this.add(new N()), this.onDispose = this._onDispose.event, this._cachedBg = null, this._cachedFg = null, this.marker = e.marker, this.options.overviewRulerOptions && !this.options.overviewRulerOptions.position && (this.options.overviewRulerOptions.position = "full");
	}
	...
	_handleChar(e) {
		this._liveRegionLineCount < ps + 1 && (this._charsToConsume.length > 0 ? this._charsToConsume.shift() !== e && (this._charsToAnnounce += e) : this._charsToAnnounce += e, e === "\n" && (this._liveRegionLineCount++, this._liveRegionLineCount === ps + 1 && (this._liveRegion.textContent += c.get())));
	}
	_clearLiveRegion() {
...
var gs = class extends A {
	constructor(e, t, n, r, i) {
		super(), this._element = e, this._mouseService = t, this._renderService = n, this._bufferService = r, this._linkProviderService = i, this._linkCacheDisposables = [], this._isMouseOut = !0, this._wasResized = !1, this._activeLine = -1, this._onShowLinkUnderline = this._register(new N()), this.onShowLinkUnderline = this._onShowLinkUnderline.event, this._onHideLinkUnderline = this._register(new N()), this.onHideLinkUnderline = this._onHideLinkUnderline.event, this._register(k(() => {
			Xe(this._linkCacheDisposables), this._linkCacheDisposables.length = 0, this._lastMouseEvent = void 0, this._activeProviderReplies?.clear();
		})), this._register(this._bufferService.onResize(() => {
			this._clearCurrentLink(), this._wasResized = !0;
		})), this._register(F(this._element, "mouseleave", () => {
			this._isMouseOut = !0, this._clearCurrentLink();
		})), this._register(F(this._element, "mousemove", this._handleMouseMove.bind(this))), this._register(F(this._element, "mousedown", this._handleMouseDown.bind(this))), this._register(F(this._element, "mouseup", this._handleMouseUp.bind(this)));
	}
	get currentLink() {
	...
	_handleMouseUp(e) {
		...
		let t = this._positionFromMouseEvent(e, this._element, this._mouseService);
		t && this._mouseDownLink && _s(this._mouseDownLink.link, this._currentLink.link) && this._linkAtPosition(this._currentLink.link, t) && this._currentLink.link.activate(e, this._currentLink.link.text);
	}
	_clearCurrentLink(e, t) {
		!this._currentLink || !this._lastMouseEvent || (!e || !t || this._currentLink.link.range.start.y >= e && this._currentLink.link.range.end.y <= t) && (this._linkLeave(this._element, this._currentLink.link, this._lastMouseEvent), this._currentLink = void 0, Xe(this._linkCacheDisposables), this._linkCacheDisposables.length = 0);
	}
	_handleNewLink(e) {
...
var vs = class extends rs {
	...
	_handleScreenReaderModeOptionChange(e) {
		e ? !this._accessibilityManager.value && this._renderService && (this._accessibilityManager.value = this._instantiationService.createInstance(hs, this)) : this._accessibilityManager.clear();
	}
	...
	_initGlobal() {
		this._bindKeys(), this._register(F(this.element, "copy", (e) => {
			this.hasSelection() && d(e, this._selectionService);
		}));
		let e = (e) => f(e, this.textarea, this.coreService, this.optionsService);
		this._register(F(this.textarea, "paste", e)), this._register(F(this.element, "paste", e)), zi ? this._register(F(this.element, "mousedown", (e) => {
			e.button === 2 && h(e, this.textarea, this.screenElement, this._selectionService, this.options.rightClickSelectsWord);
		})) : this._register(F(this.element, "contextmenu", (e) => {
			h(e, this.textarea, this.screenElement, this._selectionService, this.options.rightClickSelectsWord);
		})), qi && this._register(F(this.element, "auxclick", (e) => {
			e.button === 1 && m(e, this.textarea, this.screenElement);
		}));
	}
	_bindKeys() {
		this._register(F(this.textarea, "keyup", (e) => this._keyUp(e), !0)), this._register(F(this.textarea, "keydown", (e) => this._keyDown(e), !0)), this._register(F(this.textarea, "keypress", (e) => this._keyPress(e), !0)), this._register(F(this.textarea, "compositionstart", () => this._compositionHelper.compositionstart())), this._register(F(this.textarea, "compositionupdate", (e) => this._compositionHelper.compositionupdate(e))), this._register(F(this.textarea, "compositionend", () => this._compositionHelper.compositionend())), this._register(F(this.textarea, "input", (e) => this._inputEvent(e), !0)), this._register(this.onRender(() => this._compositionHelper.updateCompositionElements()));
	}
	open(e) {
		...
		this._renderService.hasRenderer() || this._renderService.setRenderer(this._createRenderer()), this._register(this.onCursorMove(() => {
		...
		})), this._register(M.any(this._onScroll.event, this._inputHandler.onScroll)(() => {
			...
			!this._overviewRulerRenderer && e && this._viewportElement && this.screenElement && (this._overviewRulerRenderer = this._register(this._instantiationService.createInstance(Xr, this._viewportElement, this.screenElement)));
		}), this._charSizeService.measure(), this.refresh(0, this.rows - 1), this._initGlobal(), this.bindMouse();
	}
	_createRenderer() {
		return this._instantiationService.createInstance(Ci, this, this._document, this.element, this.screenElement, this._viewportElement, this._helperContainer, this.linkifier);
	}
	bindMouse() {
		...
		})), this.coreMouseService.activeProtocol = this.coreMouseService.activeProtocol, this._register(F(t, "mousedown", (e) => {
	...
	_keyDown(e) {
		...
		let n = as(e, this.coreService.decPrivateModes.applicationCursorKeys, this.browser.isMac, this.options.macOptionIsMeta);
	...
	_keyUp(e) {
		this._keyDownSeen = !1, !(this._customKeyEventHandler && this._customKeyEventHandler(e) === !1) && (ys(e) || this.focus(), this.updateCursorStyle(e), this._keyPressHandled = !1);
	}
	_keyPress(e) {
		let t;
...
var bs = class {
	...
	getCell(e, t) {
		if (!(e < 0 || e >= this._line.length)) return t ? (this._line.loadCell(e, t), t) : this._line.loadCell(e, new v());
	}
	...
	constructor(e) {
		super(), this._core = e, this._onBufferChange = this._register(new N()), this.onBufferChange = this._onBufferChange.event, this._normal = new Ss(this._core.buffers.normal, "normal"), this._alternate = new Ss(this._core.buffers.alt, "alternate"), this._core.buffers.onBufferActivate(() => this._onBufferChange.fire(this.active));
	}
	get active() {
...
}, Es = ["cols", "rows"], Ds = 0, Os = class extends A {
	constructor(e) {
		super(), this._core = this._register(new vs(e)), this._addonManager = this._register(new bs()), this._publicOptions = { ...this._core.options };
	...
	_verifyIntegers(...e) {
		for (Ds of e) if (Ds === Infinity || isNaN(Ds) || Ds % 1 != 0) throw Error("This API only accepts integers");
	}
	_verifyPositiveIntegers(...e) {
		for (Ds of e) if (Ds && (Ds === Infinity || isNaN(Ds) || Ds % 1 != 0 || Ds < 0)) throw Error("This API only accepts positive integers");
	}
};
//#endregion
export { Os as Dl };
