var e = {
	...
	requires: {
		integrations: { github: { message: "Used to read labelled issues, push the branch, and open the pull request." } },
	...
	setup: {
		...
		bundle: {
			...
			timeout: 900,
			files: { "main.py": "skills/github-issue-to-pr/scripts/main.py" },
			config: {
