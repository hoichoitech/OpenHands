var e = {
	...
	requires: { integrations: {
		"atlassian-rovo": { message: "Provides the Atlassian Rovo MCP connection used to access Jira data." },
		github: { message: "Opens a pull request on the repository named in the ticket." }
	} },
	popularityRank: 85,
