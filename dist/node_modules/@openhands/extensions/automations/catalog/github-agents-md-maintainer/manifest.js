var e = {
	...
	requires: {
		integrations: { github: { message: "Used to read the repository, push the branch, and open the pull request." } },
	...
	setup: {
		...
		bundle: {
			...
			timeout: 900,
			files: { "main.py": "skills/github-agents-md-maintainer/scripts/main.py" },
			config: {
