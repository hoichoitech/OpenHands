var e = {
	...
	requires: {
		integrations: {
			linear: { message: "Reads implementation-ready issues and posts progress back to Linear." },
			bitbucket: { message: "Clones the target repository, pushes a branch, and opens the pull request." }
		},
		features: ["conversationDispatch"]
	},
	popularityRank: 87,
