require("../../../../_virtual/_rolldown/runtime.cjs");var e=[`automations`,`environment`,`code-hosting`,`agent-authoring`,`code-quality`,`integrations`,`writing`,`design`,`other`],t=[{name:`add-javadoc`,description:`Add comprehensive JavaDoc documentation to Java classes and methods. Use when documenting Java code, adding API documentation, or improving code documentation.`,triggers:[`javadoc`,`java documentation`,`document java`],content:`Add comprehensive JavaDoc documentation to all public classes and methods.
...
vercel env pull
\`\`\``,category:`integrations`}],n=[`add-skill`,`agent-canvas-environment`,`agent-memory`,`agent-sdk-builder`,`code-review`,`docker`,`github`,`openhands-api`,`openhands-automation`,`openhands-sdk`,`skill-creator`];exports.DEFAULT_ENABLED_SKILL_NAMES=n,exports.SKILL_CATEGORY_IDS=e,exports.default=t;
