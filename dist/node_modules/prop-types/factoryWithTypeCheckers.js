...
import { require_react_is as t } from "./node_modules/react-is/index.js";
import { require_object_assign as n } from "../object-assign/index.js";
import { require_ReactPropTypesSecret as r } from "./lib/ReactPropTypesSecret.js";
import { require_has as i } from "./lib/has.js";
import { require_checkPropTypes as a } from "./checkPropTypes.js";
//#region node_modules/prop-types/factoryWithTypeCheckers.js
var o = /* @__PURE__ */ e(((e, o) => {
	var s = t(), c = n(), l = r(), u = i(), d = a(), f = function() {};
	...
	o.exports = function(e, t) {
		...
		function g(e) {
			...
			function i(i, o, s, c, u, d, p) {
				...
				return o[s] == null ? i ? o[s] === null ? new h("The " + u + " `" + d + "` is marked as required " + ("in `" + c + "`, but its value is `null`.")) : new h("The " + u + " `" + d + "` is marked as required in " + ("`" + c + "`, but its value is `undefined`.")) : null : e(o, s, c, u, d);
			}
			var o = i.bind(null, !1);
		...
		function x() {
			function e(e, t, n, r, i) {
				var a = e[t];
				if (!s.isValidElementType(a)) {
					var o = M(a);
					return new h("Invalid " + r + " `" + i + "` of type " + ("`" + o + "` supplied to `" + n + "`, expected a single ReactElement type."));
				}
				return null;
			}
			return g(e);
		...
		function S(e) {
			function t(t, n, r, i, o) {
				if (!(t[n] instanceof e)) {
					var s = e.name || a, c = F(t[n]);
					return new h("Invalid " + i + " `" + o + "` of type " + ("`" + c + "` supplied to `" + r + "`, expected ") + ("instance of `" + s + "`."));
				}
				return null;
			}
			return g(t);
			...
			switch (typeof t) {
				...
				case "object":
					...
					if (n) {
						var r = n.call(t), a;
						if (n !== t.entries) {
							for (; !(a = r.next()).done;) if (!A(a.value)) return !1;
		...
		return o.checkPropTypes = d, o.resetWarningCache = d.resetWarningCache, o.PropTypes = o, o;
	};
}));
//#endregion
export default o();
export { o as require_factoryWithTypeCheckers };
