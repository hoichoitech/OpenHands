...
var e = (e) => !!e.dispatchFromDevtools && typeof e.dispatch == "function", t = /* @__PURE__ */ new Map(), n = (e) => {
	let n = t.get(e);
...
var c = (t, a = {}) => (o, c, u) => {
	let { enabled: d, anonymousActionType: f, store: p, ...m } = a, h;
	try {
		h = (d ?? !1) && window.__REDUX_DEVTOOLS_EXTENSION__;
	} catch {}
	if (!h) return t(o, c, u);
	let { connection: g, ..._ } = r(p, h, m), v = !0;
	u.setState = ((e, t, r) => {
		let i = o(e, t);
		if (!v) return i;
		let a = r === void 0 ? { type: f || s((/* @__PURE__ */ Error()).stack) || "anonymous" } : typeof r == "string" ? { type: r } : r;
		return p === void 0 ? (g?.send(a, c()), i) : (g?.send({
			...a,
			type: `${p}/${a.type}`
		}, {
			...n(m.name),
		...
		switch (t.type) {
			...
			case "DISPATCH":
				switch (t.payload.type) {
					case "RESET": return y(b), p === void 0 ? g?.init(u.getState()) : g?.init(n(m.name));
					case "COMMIT":
						if (p === void 0) {
							g?.init(u.getState());
							return;
					...
					case "ROLLBACK": return l(t.state, (e) => {
						if (p === void 0) {
					...
					case "JUMP_TO_STATE":
					case "JUMP_TO_ACTION": return l(t.state, (e) => {
						if (p === void 0) {
							y(e);
							return;
						}
					...
					case "IMPORT_STATE": {
						let { nextLiftedState: e } = t.payload, n = e.computedStates.slice(-1)[0]?.state;
						if (!n) return;
						y(p === void 0 ? n : n[p]), g?.send(null, e);
						return;
					}
					case "PAUSE_RECORDING": return v = !v;
				}
				return;
		}
	}), b;
...
var d = (e) => (t) => {
	...
	let a = {
		...
		...t
	}, o = !1, s = 0, c = /* @__PURE__ */ new Set(), l = /* @__PURE__ */ new Set(), f = a.storage;
	if (!f) return e((...e) => {
	...
	let g, _ = () => {
		if (!f) return;
		let e = ++s;
		o = !1, c.forEach((e) => e(r() ?? h));
		let t = a.onRehydrateStorage?.call(a, r() ?? h) || void 0;
		return d(f.getItem.bind(f))(a.name).then((e) => {
			...
			e === s && (t?.(r(), void 0), g = r(), o = !0, l.forEach((e) => e(g)));
		}).catch((n) => {
			e === s && t?.(void 0, n);
		});
	};
...
//#endregion
export { u as createJSONStorage, c as devtools, f as persist };
