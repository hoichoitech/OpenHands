...
export declare class SecretsService {
     ...
     */
    static createSecret(name: string, value: string, description?: string): Promise<void>;
    /**
     ...
     * @throws Error if the API call fails after retries
     */
    static updateSecret(secretToEdit: string, name: string, description?: string, value?: string): Promise<void>;
    /**
     ...
     */
    static deleteSecret(name: string): Promise<void>;
}
