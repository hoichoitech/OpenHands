...
//#region src/hooks/query/use-llm-subscription-models.ts
function r({ enabled: r = !0 } = {}) {
	return t({
		queryKey: e.openaiModels,
		queryFn: n.getOpenAIModels,
		enabled: r,
		retry: !1,
...
//#endregion
export { r as useOpenAISubscriptionModels };

//# sourceMappingURL=use-llm-subscription-models.js.map