...
import { resumeConversation as n } from "./conversation-mutation-utils.js";
//#region src/hooks/mutation/use-resume-conversation.ts
var r = () => {
	let r = e();
	return t({
		...
		onSettled: (e, t, n) => {
			r.invalidateQueries({ queryKey: [
				...
				"conversation",
				n.conversationId
			] }), r.invalidateQueries({ queryKey: ["user", "conversations"] }), r.invalidateQueries({ queryKey: ["v1-batch-get-app-conversations"] }), r.invalidateQueries({ queryKey: ["unified", "vscode_url"] });
		}
	});
};
//#endregion
export { r as useResumeConversation };

//# sourceMappingURL=use-resume-conversation.js.map