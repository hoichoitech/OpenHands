...
export declare const useWorkspaceMutationCounter: import("zustand").UseBoundStore<import("zustand").StoreApi<WorkspaceMutationCounterState>>;
/**
 ...
 */
export declare function withWorkspaceCacheBuster(url: string, version: number): string;
export declare function withWorkspaceCacheBuster(url: string | null, version: number): string | null;
export {};
