var e = {
	...
	bugs: { url: "https://github.com/OpenHands/OpenHands/issues" },
	bin: { "agent-canvas": "bin/agent-canvas.mjs" },
	engines: { node: ">=24" },
	dependencies: {
		"@heroui/react": "2.8.10",
		"@microlink/react-json-view": "1.31.25",
		"@monaco-editor/react": "4.7.0",
		"@openhands/extensions": "0.20.0",
		"@openhands/typescript-client": "1.46.0",
	...
	scripts: {
		...
		"test:mutation:diff": "npm run make-i18n && node scripts/stryker-diff.mjs",
		"test:mutation:incremental": "npm run make-i18n && stryker run --incremental",
		...
		"build:lib": "npm run make-i18n && react-router typegen && cross-env BUILD_LIB=true vite build && tsc -p tsconfig.lib.json && node scripts/patch-lib-build.mjs",
		"build:docker": "node scripts/docker-build.mjs",
		"example:acp-docker:env": "node scripts/gen-acp-docker-env.mjs",
		predesktop: "node scripts/brand-dev-electron.mjs",
		desktop: "npm run build:app && electron electron",
	...
	"lint-staged": {
		...
		"src/**/*.{ts,tsx}": ["node scripts/run-staged-typecheck.mjs"],
		"src/**/*": ["npm run check-translation-completeness"]
	},
	devDependencies: {
	...
	exports: {
		...
		"./styles.css": "./dist/agent-canvas.css",
