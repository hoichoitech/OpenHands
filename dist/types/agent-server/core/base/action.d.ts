 ...
 */
export interface CanvasUIAction extends ActionBase<"CanvasUIAction" | typeof CANVAS_UI_CLIENT_ACTION_KIND> {
 ...
 */
export interface LaunchChildConversationAction extends ActionBase<typeof LAUNCH_CHILD_CONVERSATION_ACTION_KIND> {
    target: string;
    task: string;
    title?: string | null;
...
export type Action = MCPToolAction | FinishAction | ThinkAction | ExecuteBashAction | TerminalAction | FileEditorAction | StrReplaceEditorAction | TaskTrackerAction | PlanningFileEditorAction | BrowserNavigateAction | BrowserClickAction | BrowserTypeAction | BrowserGetStateAction | BrowserGetContentAction | BrowserScrollAction | BrowserGoBackAction | BrowserListTabsAction | BrowserSwitchTabAction | BrowserCloseTabAction | GlobAction | GrepAction | InvokeSkillAction | TaskAction | SwitchLLMAction | CanvasUIAction | LaunchChildConversationAction;
