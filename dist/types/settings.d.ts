...
export declare const ProviderOptions: {
    ...
    readonly bitbucket_data_center: "bitbucket_data_center";
...
export type SettingsValue = boolean | number | string | null | SettingsValue[] | {
    [key: string]: SettingsValue;
};
export type SettingsValueType = "string" | "integer" | "number" | "boolean" | "array" | "object";
