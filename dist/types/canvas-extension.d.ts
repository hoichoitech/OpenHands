export declare const CANVAS_EXTENSION_MANIFEST_SCHEMA_VERSION: 1;
export declare const CANVAS_EXTENSION_HOST_API_VERSION: "1";
...
export type CanvasExtensionPageMount = (context: CanvasExtensionPageMountContext) => void | CanvasExtensionDispose | Promise<void | CanvasExtensionDispose>;
...
export interface CanvasExtensionHost {
    ...
    registerPage: (contributionId: string, mount: CanvasExtensionPageMount) => CanvasExtensionDispose;
    navigate: (path: string) => void;
    agentServer: {
        request: <T = unknown>(request: CanvasExtensionAgentServerRequest) => Promise<T>;
    };
}
export interface CanvasExtensionModule {
    activate: (host: CanvasExtensionHost) => void | CanvasExtensionDispose | Promise<void | CanvasExtensionDispose>;
}
