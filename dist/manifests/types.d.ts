 ...
 */
export declare const SETUP_VERSION = "1.0";
export type SetupMode = "direct" | "assisted";
export type SetupFieldType = "text" | "textarea" | "select" | "number" | "cron" | "timezone" | "repo-picker" | "llm-profile" | "event-source" | "event-type" | "plugin-sources" | "tarball-upload";
...
export declare const SETUP_PLACEHOLDER_NAMESPACES: readonly ["form", "automation"];
...
export type SetupBundleConfigValue = string | number | boolean | null | SetupBundleConfigValue[] | {
 ...
 */
export declare const BUNDLE_CONFIG_FILENAME = "config.json";
/**
...
export type SetupAction = SetupPromptAction | SetupPluginAction | SetupUploadAction;
...
export type SetupPayloadValue = string | number | boolean | null | SetupPayloadValue[] | {
 ...
 */
export declare const INTERFACE_VERSION = "1.0";
/** The closed set of runtime-model properties a client may offer for setting. */
export type AutomationAttributeName = "name" | "prompt" | "model" | "timeout" | "schedule";
export type InterfaceAttributeType = "text" | "textarea" | "number" | "llm-profile" | "schedule";
 ...
 */
export declare const INTERFACE_SUB_PAGE_IDS: readonly ["list", "templates"];
...
export declare const INTERFACE_ICON_SLUGS: readonly ["layout-dashboard", "sparkles", "library", "bot", "circle-alert", "activity", "timer"];
...
export declare const OVERVIEW_METRICS: readonly ["automations", "needs-attention", "total-runs", "average-duration"];
 ...
 */
export declare const OVERVIEW_TILE_PLACEHOLDERS: Record<OverviewMetric, readonly string[]>;
...
export declare const DASHBOARD_FILTER_VALUES: {
    readonly status: readonly ["all", "active", "failing", "disabled"];
    readonly trigger: readonly ["all", "schedule", "event"];
};
export type DashboardFilterId = keyof typeof DASHBOARD_FILTER_VALUES;
export declare const DASHBOARD_FILTER_IDS: readonly DashboardFilterId[];
export type DashboardStatusValue = (typeof DASHBOARD_FILTER_VALUES.status)[number];
export type DashboardTriggerValue = (typeof DASHBOARD_FILTER_VALUES.trigger)[number];
...
export interface InterfaceTriggerFilter {
    ...
    label: string;
    options: {
        value: DashboardTriggerValue;
        label: string;
    }[];
}
export type InterfaceDashboardFilter = InterfaceStatusFilter | InterfaceTriggerFilter;
/** Sort values name comparators this host implements. */
export declare const DASHBOARD_SORT_VALUES: readonly ["last-run", "runs", "name"];
